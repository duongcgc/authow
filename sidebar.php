...
if ( is_home() || is_front_page() ) {
	...
	if ( 'page' == $show_on_front ) {
		$custom_sidebar_pages = get_post_meta( get_the_ID(), 'goso_custom_sidebar_page_display', true );
	...
	$custom_sidebar_post = get_post_meta( get_the_ID(), 'goso_custom_sidebar_page_display', true );
...
$product_sidebar = 'goso-shop-single';
if ( function_exists( 'goso_get_single_product_meta' ) ) {
	$product_sidebar = goso_get_single_product_meta( get_the_ID(), 'product_sidebar', 'sidebar_area', $product_sidebar );
}
?>

<div id="sidebar"
     class="goso-sidebar-right goso-sidebar-content <?php echo esc_attr( $heading_title . ' ' . $heading_align . ' ' . $sidebar_style . ' ' . $sidebar_icon_pos . ' ' . $sidebar_icon_design ); ?><?php if ( get_theme_mod( 'goso_sidebar_sticky' ) ): echo ' goso-sticky-sidebar'; endif; ?>">
    <div class="theiaStickySidebar">
		...
		if ( is_singular( 'portfolio' ) && is_active_sidebar( $sidebar_portfolio ) ) {
			...
			if ( ( is_shop() || is_product_category() || is_product_tag() ) && is_active_sidebar( 'goso-shop-sidebar' ) ) {
				dynamic_sidebar( 'goso-shop-sidebar' );
