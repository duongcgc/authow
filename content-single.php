...
$style_cscount = get_theme_mod( 'goso_single_style_cscount' );
...
<article id="post-<?php the_ID(); ?>" class="post type-post status-publish<?php do_action( 'goso_post_class' ); ?>">
                    ...
                    <div class="post-box-meta-single">
						<?php if ( ! get_theme_mod( 'goso_single_meta_author' ) ) : ?>
                            <span class="author-post byline"><span
                                        class="author vcard"><?php echo goso_get_setting( 'goso_trans_written_by' ); ?> <a
						...
						<?php endif; ?>
						<?php if ( ! get_theme_mod( 'goso_single_meta_comment' ) && 's1' != $style_cscount ) : ?>
	...
	<?php if ( get_theme_mod( 'goso_move_title_bellow' ) && 'style-2' != $single_style ): ?>
