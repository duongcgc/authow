...
?>
<li class="grid-style magazine-layout magazine-2<?php if ( get_theme_mod( 'goso_grid_meta_overlay' ) ): echo ' grid-overlay-meta'; endif; ?>">
						...
						<?php foreach ( $images as $image ) : ?>
							...
							<?php if ( ! get_theme_mod( 'goso_disable_lazyload_layout' ) ) { ?>
                                <figure class="goso-image-holder goso-lazy"
                                        ...
                                        data-bgset="<?php echo goso_image_srcset( get_the_ID()); ?>">
                                </figure>
							<?php } else { ?>
...
if ( isset( $infeed_ads ) && $infeed_ads ) {
	goso_get_markup_infeed_ad(
		array(
			'wrapper'    => 'li',
			'classes'    => 'grid-style magazine-layout magazine-2 goso-infeed-data',
