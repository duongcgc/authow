...
?>
<article id="post-<?php the_ID(); ?>" class="item item-masonry grid-masonry hentry<?php if( get_theme_mod('goso_grid_meta_overlay') ): echo ' grid-overlay-meta'; endif; ?>">
...
if( isset( $infeed_ads ) && $infeed_ads ){
	goso_get_markup_infeed_ad(
		array(
			'wrapper' => 'article',
			'classes'      => 'item item-masonry grid-masonry goso-infeed-data',
