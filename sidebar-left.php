...
$sidebar_portfolio = get_theme_mod( 'goso_sidebar_left_single_portfolio' );
...
if ( is_home() || is_front_page() ) {
	...
	$custom_sidebar_post = get_post_meta( get_the_ID(), 'goso_custom_sidebar_left_page_field', true );
...
<div id="sidebar"
     class="goso-sidebar-left goso-sidebar-content <?php echo esc_attr( $heading_title . ' ' . $heading_align . ' ' . $sidebar_style . ' ' . $sidebar_icon_pos . ' ' . $sidebar_icon_design ); ?><?php if ( get_theme_mod( 'goso_sidebar_sticky' ) ): echo ' goso-sticky-sidebar'; endif; ?>">
