...
if ( ! function_exists( 'penci_authow_get_header_layout' ) ):
	function penci_authow_get_header_layout() {
...
if ( ! function_exists( 'penci_authow_get_header_width' ) ):
	function penci_authow_get_header_width() {
...
if ( ! function_exists( 'penci_authow_get_header_container_width' ) ):
	function penci_authow_get_header_container_width() {
		$header_width = get_theme_mod( 'penci_header_ctwidth' );
		if ( is_page() ) {
			$pmeta_page_header = get_post_meta( get_the_ID(), 'penci_pmeta_page_header', true );
			if ( isset( $pmeta_page_header['penci_header_width'] ) && $pmeta_page_header['penci_header_width'] ) {
...
if ( ! function_exists( 'penci_authow_wpheader_classes' ) ):
	function penci_authow_wpheader_classes( $class = '' ) {
		...
		$header_layout               = penci_authow_get_header_layout();
...
if ( ! function_exists( 'penci_authow_sitenavigation_classes' ) ):
	function penci_authow_sitenavigation_classes( $class = '' ) {
...
if ( ! function_exists( 'penci_authow_body_classes' ) ):
	function penci_authow_body_classes( $classes ) {
	...
	add_filter( 'body_class', 'penci_authow_body_classes' );
endif;
...
if ( ! is_user_logged_in() && get_theme_mod( 'penci_enable_spoptimizer' ) && function_exists( 'hpp_shouldlazy' ) && hpp_shouldlazy() ) {
	...
	add_filter( 'hpp_allow_generate_css', function ( $ok ) {
		return get_option( 'penci_authow_is_activated' ) ? true : false;
	} );
...
if ( ! function_exists( 'penci_add_postviews_col' ) ) {
	...
	function penci_add_postviews_col( $columns ) {
		$columns['penci_thumbnail'] = __( 'Thumbnail', 'authow' );
