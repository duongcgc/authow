...
if( ! class_exists( 'Authow_VC_Admin' ) && function_exists( 'vc_map' ) ) {
	class Authow_VC_Admin {
		...
		public function integrate() {
			...
			// Latest Posts
			vc_map( array(
				'name'        => goso_get_theme_name('Goso').' '.__( 'Latest Posts', 'authow' ),
				...
				'params'      => array_merge(
					array(
						...
						array(
							'type'        => 'dropdown',
							'heading'     => __( 'Latest Posts Layout', 'authow' ),
							'value'       => array(
						...
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Mixed Post Style', 'authow' ),
							'default'    => 's1',
							'value'      => array(
								'Style 1' => 's1',
								'Style 2' => 's2',
							),
							'param_name' => 'goso_mixed_style',
							'dependency' => array( 'element' => 'style', 'value' => array( 'mixed', 'mixed-2' ) ),
						),
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Post Header Alignment', 'authow' ),
							'value'      => array(
								'Default' => '',
								'Left'    => 'left',
								'Center'  => 'center',
						...
						array(
							'type'             => 'goso_number',
							'param_name'       => 'goso_items_martop',
							'heading'          => __( 'Rows Gap Between Post Items', 'authow' ),
							'value'            => '',
							'std'              => '',
							'suffix'           => 'px',
							'min'              => 1,
						...
						array(
							'type'             => 'goso_number',
							'param_name'       => 'goso_bitems_martop',
							'heading'          => __( 'Rows Gap Between Big Items', 'authow' ),
							'value'            => '',
							'std'              => '',
							'suffix'           => 'px',
							'min'              => 1,
						...
						array(
							'type'             => 'goso_number',
							'param_name'       => 'goso_sitems_martop',
							'heading'          => __( 'Rows Gap Between Small List Posts Items', 'authow' ),
							'value'            => '',
							'std'              => '',
							'suffix'           => 'px',
							'min'              => 1,
						...
						array(
							...
							'heading'          => esc_html__( 'Standard & Classic Layouts Options', 'authow' ),
							'value'            => '',
							'edit_field_class' => 'goso-param-heading-wrapper no-top-margin vc_column vc_col-sm-12',
						),
						array(
							'type'        => 'checkbox',
							'heading'     => __( 'Enable Post Meta Overlay Featured Image', 'authow' ),
							'description' => __( 'This option just apply for Standard Layout Only', 'authow' ),
							'param_name'  => 'standard_meta_overlay',
							'value'       => array( __( 'Yes', 'authow' ) => 'yes' ),
						),
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Post Thumbnail', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Disable Autoplay for Slider on Posts Format Gallery', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Make Featured Image Auto Crop', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Category', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Post Author', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Post Date', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Comment Count', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Show Views Count', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Reading Time', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Remove Line Above Post Excerpt', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Auto Render Post Excerpt', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Post Content/Post Excerpt', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Disable Hover Effect on "Continue Reading" Button', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Make "Continue Reading" is A Button', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Share Icons', 'authow' ),
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Custom Excerpt Length', 'authow' ),
							'param_name' => 'standard_excerpt_length',
						),
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Align Excerpt', 'authow' ),
							'value'      => array(
								'Default'   => '',
								'Left'   => 'left',
								'Center' => 'center',
						...
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Align "Continue Reading" Button', 'authow' ),
							'value'      => array(
								'Default'   => '',
								'Left'   => 'left',
								'Center' => 'center',
						...
						array(
							...
							'heading'          => esc_html__( 'Other Layouts Options', 'authow' ),
							'value'            => '',
							'edit_field_class' => 'goso-param-heading-wrapper no-top-margin vc_column vc_col-sm-12',
						),
						array(
							...
							'std'        => '',
							'param_name' => 'goso_featimg_size',
						),
						array(
							'type'       => 'goso_only_number',
							'heading'    => esc_html__( 'Image Ratio.Unit is %. E.g: 50', 'authow' ),
							'param_name' => 'goso_featimg_ratio',
							'value'      => '',
							'std'        => '',
							'min'        => 0,
							'max'        => 100,
							'suffix'     => '%',
							'dependency' => array( 'element' => 'goso_featimg_size', 'value' => 'custom' ),
						),
						array(
							'type'             => 'dropdown',
						...
						array(
							'type'             => 'dropdown',
							'heading'          => __( 'Custom Image Size for Big Posts', 'authow' ),
							'value'            => array(
								'Default' => '',
								'Thumbnail - 150 x 150' => 'thumbnail',
								'Medium - 300 x 300' => 'medium',
						...
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Columns on Desktop', 'authow' ),
							'value'      => array(
								'Default'   => '',
								1 => 1,
								2 => 2,
						...
						array(
							'type'             => 'dropdown',
							'heading'          => __( 'Columns on Tablet', 'authow' ),
							'value'            => array(
								'Default' => '',
								1 => 1,
								2 => 2,
						...
						array(
							'type'             => 'dropdown',
							'heading'          => __( 'Columns on Mobile', 'authow' ),
							'value'            => array(
								'Default' => '',
								1 => 1,
								2 => 2,
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Icon Post Format', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Enable Uppercase on Post Categories', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Do Not Crop Images in List Layouts', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Share Box', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Hide Comment Count on Mixed & Overlay Posts', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Show Comment Count on Grid, Masonry, List, Boxed, Photography Posts', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Remove Post Excerpt', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Add "Read more" button link', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Remove arrow on "Read more"', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Make "Read more" is A Button', 'authow' ),
						...
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Share Box Alignment', 'authow' ),
							'value'      => array(
								'Default' => '',
								'Left'    => 'left',
								'Center'  => 'center',
						...
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Align "Read more" Button', 'authow' ),
							'std'        => 'left',
							'value'      => array(
								'Left'   => 'left',
								'Center' => 'center',
						...
						array(
							'type'        => 'textfield',
							'heading'     => esc_html__( 'Image Width on List & Small List Layout', 'authow' ),
							'param_name'  => 'list_imgwidth',
							'description' => __( 'Unit is px or %. Fill unit here also. Example:  <strong>200px</strong> or <strong>30%</strong>', 'authow' ),
							'dependency'  => array(
								'element' => 'style',
								'value'   => array(
									'list',
						...
						array(
							...
							'heading'          => esc_html__( 'Page Navigation', 'authow' ),
							'value'            => '',
							'edit_field_class' => 'goso-param-heading-wrapper no-top-margin vc_column vc_col-sm-12',
						),
						array(
						...
						array(
							'type'        => 'textfield',
							'heading'     => esc_html__( 'Custom Number Posts for Each Time Load More Posts', 'authow' ),
							'param_name'  => 'morenum',
							'value'       => '',
							'description' => esc_html__( 'Use numeric value only', 'authow' ),
							'dependency' => array( 'element' => 'paging', 'value' => array( 'loadmore', 'scroll' ) ),
						),
						array(
							'type'             => 'goso_number',
							'param_name'       => 'goso_paging_martop',
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Insert In-feed Ads Code After Every How Many Posts?', 'authow' ),
						...
						array(
							...
							'holder'     => 'div',
							'heading'    => __( 'In-feed Ads Code/HTML', 'authow' ),
							'param_name' => 'infeed_code',
						),
						array(
							'type'        => 'dropdown',
							'heading'     => __( 'In-feed Ads Layout Type', 'authow' ),
							'value'       => array(
						...
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Hide Heading Title', 'authow' ),
							'param_name' => 'hide_block_heading',
							'value'      => array( __( 'Yes', 'authow' ) => 'yes' ),
							'group'      => 'Heading',
						),
					),
					Goso_Vc_Params_Helper::heading_block_params( false ),
					Goso_Vc_Params_Helper::params_heading_typo_color(),
					Goso_Vc_Params_Helper::params_latest_posts_typo_color(),
					array(
						array(
							'type'       => 'css_editor',
			...
			// Featured Categories
			vc_map( array(
				'name'        => goso_get_theme_name('Goso').' '.__( 'Featured Category', 'authow' ),
				...
				'params'      => array_merge(
					array(
						...
						array(
							'type'        => 'dropdown',
							'heading'     => __( 'Featured Category Layout', 'authow' ),
							'value'       => array(
						...
						array(
							...
							'param_name'       => 'goso_columns_tablet',
							'edit_field_class' => 'vc_col-sm-4',
							'dependency'       => array( 'element' => 'style', 'value' => array( 'style-3', 'style-11' ) ),
						),
						array(
							...
							'param_name'       => 'goso_columns_mobile',
							'edit_field_class' => 'vc_col-sm-4',
							'dependency'       => array( 'element' => 'style', 'value' => array( 'style-3', 'style-11' ) ),
						),
						array(
							...
							'suffix'           => 'px',
							'min'              => 1,
							'heading'          => esc_html__( 'Columns Gap', 'authow' ),
							'param_name'       => 'goso_column_gap',
							'edit_field_class' => 'vc_col-sm-6',
						...
						array(
							...
							'suffix'           => 'px',
							'min'              => 1,
							'heading'          => esc_html__( 'Rows Gap', 'authow' ),
							'param_name'       => 'goso_row_gap',
							'edit_field_class' => 'vc_col-sm-6',
							'dependency'       => array(
								'element' => 'style',
						...
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Show Thumbnail on Small Posts', 'authow' ),
							'param_name' => 'thumb15',
							'value'      => array( __( 'Yes', 'authow' ) => 'yes' ),
						...
						array(
							...
							'suffix'           => 'px',
							'min'              => 1,
							'heading'          => esc_html__( 'Custom Image Width for Small Posts', 'authow' ),
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Custom Words Length for Post Titles for style 1,2,6,10,14', 'authow' ),
						...
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Show Post Author on Small Posts', 'authow' ),
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Show Comment Count', 'authow' ),
						...
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Hide Post Excerpt', 'authow' ),
							'param_name' => 'hide_excerpt',
							'value'      => array( __( 'Yes', 'authow' ) => 'yes' ),
						),
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Disable Autoplay for Sliders on Style 4, 5, 12', 'authow' ),
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Custom Excerpt Length for style 1,2,6,7,8,10', 'authow' ),
						...
						array(
							...
							'heading'          => esc_html__( 'View All Button', 'authow' ),
							'value'            => '',
							'edit_field_class' => 'goso-param-heading-wrapper no-top-margin vc_column vc_col-sm-12',
						),
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Enable "View All" Button', 'authow' ),
							'param_name' => 'cat_seemore',
							'value'      => array( __( 'Yes', 'authow' ) => 'yes' ),
						),
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Custom Link for "View All" Button', 'authow' ),
						...
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Remove arrow on "View All"', 'authow' ),
						...
						array(
							'type'       => 'checkbox',
							'heading'    => __( 'Make "View All" is A Button', 'authow' ),
						...
						array(
							'type'       => 'dropdown',
							'heading'    => __( 'Align "View All" Button', 'authow' ),
						...
						array(
							...
							'heading'    => __( 'Custom Margin Top for "View All" Button', 'authow' ),
							'value'      => '',
							'std'        => '',
							'suffix'     => 'px',
							'min'        => 1,
					...
					Goso_Vc_Params_Helper::heading_block_params( false ),
					Goso_Vc_Params_Helper::params_heading_typo_color( ),
					Goso_Vc_Params_Helper::params_featured_cat_typo_color(),
					array(
						array(
							'type'       => 'css_editor',
							'heading'    => __( 'CSS box', 'authow' ),
			...
			// Portfolio
			vc_map( array(
				'name'        => goso_get_theme_name('Goso').' '.__( 'Portfolio', 'authow' ),
				...
				'params'      => array(
					array(
						'type'        => 'loop',
						'heading'     => __( 'Click button below to Build Query for This Portfolio', 'authow' ),
						'param_name'  => 'loop',
						...
						'description' => __( 'Create Portfolio loop, to populate content from your site.', 'authow' ),
					),
					array(
						'type'        => 'dropdown',
					...
					array(
						'type'       => 'dropdown',
						'heading'    => esc_html__( 'Item Style', 'goso-framework' ),
						'value'      => array(
					...
					array(
						'type'       => 'dropdown',
						'heading'    => __( 'Image Type - Just apply for Grid Style', 'authow' ),
					...
					array(
						...
						'std'        => 'number',
						'value'      => array(
							esc_html__( 'Numeric Pagination', 'authow' )  => 'number',
							esc_html__( 'Load More Button', 'authow' )  => 'load_more',
							esc_html__( 'Infinite Load', 'authow' )     => 'infinite',
					...
					array(
						...
						'heading'          => esc_html__( 'Portfolio Filter', 'authow' ),
						'value'            => '',
						'group'            => $group_color,
						'edit_field_class' => 'goso-param-heading-wrapper no-top-margin vc_column vc_col-sm-12',
					),
					...
					array(
						'type'             => 'checkbox',
						'heading'          => __( 'Custom Font Family for Link', 'authow' ),
					...
					array(
						...
						'heading'          => esc_html__( 'Portfolio Title', 'authow' ),
						'value'            => '',
						'group'            => $group_color,
						'edit_field_class' => 'goso-param-heading-wrapper no-top-margin vc_column vc_col-sm-12',
					),
					array(
						'type'             => 'colorpicker',
						'heading'          => esc_html__( 'Portfolio Background Overlay Color', 'authow' ),
					...
					array(
						'type'             => 'colorpicker',
						'heading'          => esc_html__( 'Portfolio Title Color', 'authow' ),
					...
					array(
						'type'             => 'colorpicker',
						'heading'          => esc_html__( 'Portfolio Title Hover Color', 'authow' ),
					...
					array(
						...
						'heading'          => __( 'Font Size for Portfolio Title', 'authow' ),
						'value'            => '',
						'std'              => '',
						'suffix'           => 'px',
						'min'              => 1,
					...
					array(
						'type'             => 'checkbox',
						'heading'          => __( 'Custom Font Family for Portfolio Title', 'authow' ),
					...
					array(
						'type'             => 'textfield',
						'param_name'       => 'heading_ptittle_settings',
						'heading'          => esc_html__( 'Portfolio Category', 'authow' ),
						'value'            => '',
						'group'            => $group_color,
						'edit_field_class' => 'goso-param-heading-wrapper no-top-margin vc_column vc_col-sm-12',
					),
					array(
						'type'             => 'colorpicker',
						'heading'          => esc_html__( 'Portfolio Category Color', 'authow' ),
					...
					array(
						'type'             => 'colorpicker',
						'heading'          => esc_html__( 'Portfolio Category Hover Color', 'authow' ),
					...
					array(
						...
						'heading'          => __( 'Font Size for Portfolio Category', 'authow' ),
						'value'            => '',
						'std'              => '',
						'suffix'           => 'px',
						'min'              => 1,
					...
					array(
						'type'             => 'checkbox',
						'heading'          => __( 'Custom Font Family for Portfolio Category', 'authow' ),
			...
			// Popular Posts
			vc_map( array(
				'name'        => goso_get_theme_name('Goso').' '.__( 'Popular Posts', 'authow' ),
				...
				'params'      => array_merge(
					array(
						...
						array(
							'type'             => 'checkbox',
							'heading'          => __( 'Show Prev/Next Buttons', 'authow' ),
					...
					Goso_Vc_Params_Helper::heading_block_params( false ),
					Goso_Vc_Params_Helper::params_heading_typo_color(),
					Goso_Vc_Params_Helper::params_popular_posts_typo_color(),
					array(
						array(
							'type'       => 'css_editor',
							'heading'    => __( 'CSS box', 'authow' ),
			...
			// Sidebar
			vc_map( array(
				'name'        => goso_get_theme_name('Goso').' '.__( 'Authow Sidebar', 'authow' ),
				'description' => 'Display a Sidebar for Authow Theme',
				'base'        => 'authow_sidebar',
				'class'       => '',
				'controls'    => 'full',
				'icon'        => get_template_directory_uri() . '/images/vc-icon.png',
				...
				'params'      => array(
					array(
						...
						'value'       => Goso_Custom_Sidebar::get_list_sidebar_vc(),
						'param_name'  => 'sidebar',
						'description' => '',
					),
					array(
			...
			// Featured Boxes
			vc_map( array(
				'name'        => goso_get_theme_name('Goso').' '.__( 'Authow Featured Boxes', 'authow' ),
				'description' => 'Create Featured Boxes',
				'base'        => 'authow_featured_boxes',
				'class'       => '',
				'controls'    => 'full',
				'icon'        => get_template_directory_uri() . '/images/vc-icon.png',
				'category'    => goso_get_theme_name('Authow'),
				...
				'params'      => array(
					...
					array(
						'type'             => 'colorpicker',
						'heading'          => esc_html__( 'Background and Border color', 'authow' ),
					...
					array(
						'type'             => 'colorpicker',
						'heading'          => esc_html__( 'Hover text color', 'authow' ),
					...
					array(
						'type'             => 'checkbox',
						'heading'          => __( 'Custom Font Family for Text', 'authow' ),
		...
		public static function notice() {
			...
			<div class="updated">
				<p><?php _e( '<strong>Authow VC Addon</strong> requires <strong>Visual Composer</strong> plugin to be installed and activated on your site.', 'authow' ) ?></p>
			</div>
