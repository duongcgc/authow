...
if( ! class_exists( 'Authow_VC_Admin' ) && function_exists( 'vc_map' ) ) {
	class Authow_VC_Admin {
		...
		public function integrate() {
			...
			// Latest Posts
			vc_map( array(
				'name'        => penci_get_theme_name('Goso').' '.__( 'Latest Posts', 'authow' ),
					...
					array(
						...
						array(
							...
							'value'            => array(
								...
								'Goso-single-full - 1920 x auto' => 'penci-single-full',
								'Goso-slider-full-thumb - 1920 x 800' => 'penci-slider-full-thumb',
								'Goso-full-thumb - 1170 x auto' => 'penci-full-thumb',
								'Goso-slider-thumb - 1170 x 663' => 'penci-slider-thumb',
								'Goso-magazine-slider - 780 x 516' => 'penci-magazine-slider',
								'Goso-thumb - 585 x 390' => 'penci-thumb',
								'Goso-masonry-thumb - 585 x auto' => 'penci-masonry-thumb',
								'Goso-thumb-square - 585 x 585' => 'penci-thumb-square',
								'Goso-thumb-vertical - 480 x 650' => 'penci-thumb-vertical',
								'Goso-thumb-small - 263 x 175' => 'penci-thumb-small',
								'Full' => 'full',
							),
			...
			// Featured Categories
			vc_map( array(
				'name'        => penci_get_theme_name('Goso').' '.__( 'Featured Category', 'authow' ),
			...
			// Portfolio
			vc_map( array(
				'name'        => penci_get_theme_name('Goso').' '.__( 'Portfolio', 'authow' ),
			...
			// Popular Posts
			vc_map( array(
				'name'        => penci_get_theme_name('Goso').' '.__( 'Popular Posts', 'authow' ),
			...
			// Sidebar
			vc_map( array(
				'name'        => penci_get_theme_name('Goso').' '.__( 'Authow Sidebar', 'authow' ),
			...
			// Featured Boxes
			vc_map( array(
				'name'        => penci_get_theme_name('Goso').' '.__( 'Authow Featured Boxes', 'authow' ),
