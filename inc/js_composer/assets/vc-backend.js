...
! function() {
	...
	function($) {
		...
		window.VcGosoContainerView = vc.shortcode_view.extend({
			...
			changeShortcodeParams: function(model) {
				window.VcGosoContainerView.__super__.changeShortcodeParams.call(this, model), this.buildDesignHelpers(), this.setRowClasses()
			},
			...
			ready: function(e) {
				return window.VcGosoContainerView.__super__.ready.call(this, e), this
			},
			checkIsEmpty: function() {
				window.VcGosoContainerView.__super__.checkIsEmpty.call(this), this.setSorting()
			},
			...
			remove: function() {
				this.$content && this.$content.data("uiSortable") && this.$content.sortable("destroy"), this.$content && this.$content.data("uiDroppable") && this.$content.droppable("destroy"), delete vc.app.views[this.model.id], window.VcGosoContainerView.__super__.remove.call(this)
			}
		});
