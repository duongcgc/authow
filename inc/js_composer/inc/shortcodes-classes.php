...
class WPBakeryShortCode_Goso_Count_Down extends WPBakeryShortCode {
...
class WPBakeryShortCode_Goso_Counter_Up extends WPBakeryShortCode {
	public function __construct( $settings ) {
		parent::__construct( $settings );
		$this->jsCssScripts();
	}
	...
	public function jsCssScripts() {
		...
		wp_enqueue_script( 'jquery-counterup', get_template_directory_uri() . '/js/jquery.counterup.min.js', array(
			'jquery',
			'waypoints'
		), '1.0', true );
	}
...
class WPBakeryShortCode_Goso_Media_Carousel extends WPBakeryShortCodesContainer {
}

class WPBakeryShortCode_Goso_Custom_Slider extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Facebook_Page extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Fancy_Heading extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Google_Map extends WPBakeryShortCode {
	public function __construct( $settings ) {
		parent::__construct( $settings );
		$this->jsCssScripts();
	}
...
class WPBakeryShortCode_Goso_Image_Gallery extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Info_Box extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Instagram extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Latest_Tweets extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Login_Form extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Mailchimp extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Open_Hours extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Pinterest extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Pricing_Table extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Progress_Bar extends WPBakeryShortCode {
...
class WPBakeryShortCode_Goso_Single_Video extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Social_Counter extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Social_Media extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Team_Member extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Testimonial_Slider extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Testimonial extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Text_Block extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Video_Playlist extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Weather extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Popular_Cat extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Container extends WPBakeryShortCode {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		$controls_move   = '<a class="vc_control column_move vc_column-move" href="#" title="' . __( 'Drag row to reorder', 'authow' ) . '" data-vc-control="move"><i class="vc-composer-icon vc-c-icon-dragndrop"></i>' . $controls_title . '</a>';
		$controls_delete = '<a class="vc_control column_delete vc_column-delete" href="#" title="' . __( 'Delete this row', 'authow' ) . '" data-vc-control="delete"><i class="vc-composer-icon vc-c-icon-delete_empty"></i></a>';
		$controls_edit   = ' <a class="vc_control column_edit vc_column-edit" href="#" title="' . __( 'Edit this row', 'authow' ) . '" data-vc-control="edit"><i class="vc-composer-icon vc-c-icon-mode_edit"></i></a>';
		$controls_clone  = ' <a class="vc_control column_clone vc_column-clone" href="#" title="' . __( 'Clone this row', 'authow' ) . '" data-vc-control="clone"><i class="vc-composer-icon vc-c-icon-content_copy"></i></a>';
		$controls_toggle = ' <a class="vc_control column_toggle vc_column-toggle" href="#" title="' . __( 'Toggle row', 'authow' ) . '" data-vc-control="toggle"><i class="vc-composer-icon vc-c-icon-arrow_drop_down"></i></a>';
...
class WPBakeryShortCode_Goso_Column extends WPBakeryShortCode {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		if ( ' bottom-controls' === $extended_css ) {
			$control_title = __( 'Append to this column', 'authow' );
		} else {
			$control_title = __( 'Prepend to this column', 'authow' );
		}
		...
		$controls_edit = '<a class="vc_control column_edit vc_column-edit"  data-vc-control="edit" href="#" title="' . __( 'Edit this column', 'authow' ) . '"><i class="vc-composer-icon vc-c-icon-mode_edit"></i></a>';
		//$controls_delete = '<a class="vc_control column_delete vc_column-delete" data-vc-control="delete"  href="#" title="' . __( 'Delete this column', 'authow' ) . '"><i class="vc-composer-icon vc-c-icon-delete_empty"></i></a>';
		$controls_delete = '';
		$editAccess      = vc_user_access_check_shortcode_edit( $this->shortcode );
		$allAccess       = vc_user_access_check_shortcode_all( $this->shortcode );
		if ( is_array( $controls ) && ! empty( $controls ) ) {
...
class WPBakeryShortCode_Goso_Container_Inner extends WPBakeryShortCode {
	public $nonDraggableClass = 'vc-non-draggable-row';
	protected $predefined_atts = array(
		'el_class' => '',
	);
...
class WPBakeryShortCode_Goso_Column_Inner extends WPBakeryShortCode {
	public $nonDraggableClass = 'vc-non-draggable-column';
	/**
	 * @var array
	 */
...
class WPBakeryShortCode_Goso_Advanced_List extends WPBakeryShortCodesContainer {
}

class WPBakeryShortCode_Goso_Advanced_List_Item extends WPBakeryShortCode {
}

class WPBakeryShortCode_Goso_Product_Tabs extends WPBakeryShortCodesContainer {
}

class WPBakeryShortCode_Goso_Product_Tab extends WPBakeryShortCode {
}
