...
if( ! class_exists( 'Goso_WPB_VC' ) ):
	class Goso_WPB_VC {
		...
		public function get_custom_fonts() {
			$fontfamily1  = get_theme_mod( 'authow_custom_fontfamily1' );
			$fontfamily2  = get_theme_mod( 'authow_custom_fontfamily2' );
			$fontfamily3  = get_theme_mod( 'authow_custom_fontfamily3' );
			$fontfamily4  = get_theme_mod( 'authow_custom_fontfamily4' );
			$fontfamily5  = get_theme_mod( 'authow_custom_fontfamily5' );
			$fontfamily6  = get_theme_mod( 'authow_custom_fontfamily6' );
			$fontfamily7  = get_theme_mod( 'authow_custom_fontfamily7' );
			$fontfamily8  = get_theme_mod( 'authow_custom_fontfamily8' );
			$fontfamily9  = get_theme_mod( 'authow_custom_fontfamily9' );
			$fontfamily10 = get_theme_mod( 'authow_custom_fontfamily10' );
