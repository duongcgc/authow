...
<?php if ( $feat_query->have_posts() ) : ?>
	<div class="item">
		<div class="wrapper-item wrapper-item-classess">
			...
			?>
			<div class="goso-item-mag goso-item-<?php echo ( $i%7 ); ?>  <?php echo ( ( $i%7 == 1 ) ? 'goso-pitem-big' : 'goso-pitem-small' ) ?>">
				<a class="goso-image-holder" style="background-image: url('<?php echo goso_get_featured_image_size( get_the_ID(), $thumb ); ?>');" href="<?php the_permalink(); ?>" title="<?php echo wp_strip_all_tags( get_the_title() ); ?>"></a>
