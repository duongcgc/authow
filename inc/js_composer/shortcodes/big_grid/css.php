...
if ( $bgsub_title_typo ) {
	$css .= $id . ' .penci-bgrid-based-custom .pcbg-content-inner .pcbg-above, ' . $id . ' .pcbg-content-inner .pcbg-above span,' . $id . ' .pcbg-content-inner .pcbg-above span a{' . penci_authow_vc_extract_font_prop( $bgsub_title_typo ) . '}';
}

if ( $bgtitle_typo_big ) {
	$css .= $id . ' .pcbg-big-item .pcbg-content-inner .pcbg-title,' . $id . ' .pcbg-big-item .pcbg-content-inner .pcbg-title a{' . penci_authow_vc_extract_font_prop( $bgtitle_typo_big ) . '}';
}

if ( $bgtitle_typo ) {
	$css .= $id . ' .pcbg-content-inner .pcbg-title,' . $id . ' .pcbg-content-inner .pcbg-title a{' . penci_authow_vc_extract_font_prop( $bgtitle_typo ) . '}';
}

if ( $title_typo ) {
	$css .= $id . ' .pcbg-content-inner .pcbg-meta,' . $id . ' .pcbg-content-inner .pcbg-meta span, ' . $id . ' .pcbg-content-inner .pcbg-meta a{' . penci_authow_vc_extract_font_prop( $title_typo ) . '}';
}

if ( $bgreadm_typo ) {
	$css .= $id . ' .pcbg-readmore-sec .pcbg-readmorebtn{' . penci_authow_vc_extract_font_prop( $bgreadm_typo ) . '}';
}
...
if ( $bgpagi_typo ) {
	$css .= $id . ' .penci-pagination a, ' . $id . ' .penci-pagination span.current{' . penci_authow_vc_extract_font_prop( $bgpagi_typo ) . '}';
}
