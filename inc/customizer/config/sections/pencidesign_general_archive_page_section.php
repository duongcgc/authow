...
$penci_featured_cat_layout = [
	...
	'style-1 penci-grid-col-2' => esc_html__( 'Grid 2 Columns', 'authow' ),
	'style-1 penci-grid-col-3' => esc_html__( 'Grid 3 Columns', 'authow' ),
	'style-1 penci-grid-col-4' => esc_html__( 'Grid 4 Columns', 'authow' ),
	'style-1 penci-grid-col-5' => esc_html__( 'Grid 5 Columns', 'authow' ),
