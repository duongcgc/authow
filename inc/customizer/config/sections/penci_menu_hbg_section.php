...
$options[] = array(
	...
	'choices'     => array(
		...
		'style-6 penci-social-textcolored'                => esc_html__( 'Icons with Brand Color', 'authow' ),
		'style-2'                                         => esc_html__( 'Round with Border', 'authow' ),
		'style-2 hgb-social-style-3'                      => esc_html__( 'Square with Border', 'authow' ),
		'style-4 penci-social-colored'                    => esc_html__( 'Round with Brand Color', 'authow' ),
		'style-4 hgb-social-style-5 penci-social-colored' => esc_html__( 'Square with Brand Color', 'authow' ),
	)
);
$options[] = array(
	'default'  => '14',
