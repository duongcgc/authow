...
$options[] = array(
	'default'     => '',
	'description' => 'Will override the pre-build single posts template above. You can add new and edit a single post template on <a target="_blank" href="' . esc_url( admin_url( '/edit.php?post_type=custom-post-template' ) ) . '">this page</a>',
	'sanitize'    => 'goso_sanitize_choices_field',
	'label'       => 'Custom Post Builder Template',
	'id'          => 'goso_single_custom_template',
	'type'        => 'authow-fw-select',
...
$options[] = array(
	'default'         => '780',
	'sanitize'        => 'absint',
	'label'           => __( 'Custom Width for "No Sidebar with Container Width Smaller" Layout You Selected Above', 'authow' ),
	'id'              => 'goso_single_smaller_width',
	'type'            => 'authow-fw-size',
	'ids'             => array(
		'desktop' => 'goso_single_smaller_width',
	),
	'choices'         => array(
		'desktop' => array(
			'min'     => 1,
...
$options[] = array(
	'default'     => '',
	'sanitize'    => 'absint',
	'label'       => __( 'Custom Container Width on Single Posts Page', 'authow' ),
	'description' => 'Minimum is 600px',
	'id'          => 'goso_single_container_w',
	'type'        => 'authow-fw-size',
	'ids'         => array(
		'desktop' => 'goso_single_container_w',
	),
	'choices'     => array(
		'desktop' => array(
			'min'  => 1,
...
$options[] = array(
	'default'     => '',
	'sanitize'    => 'absint',
	'label'       => __( 'Custom Container Width for Two Sidebars on Single Posts Page', 'authow' ),
	'description' => 'Minimum is 800px',
	'id'          => 'goso_single_container2_w',
	'type'        => 'authow-fw-size',
	'ids'         => array(
		'desktop' => 'goso_single_container2_w',
	),
	'choices'     => array(
		'desktop' => array(
			'min'  => 1,
...
$options[] = array(
	...
	'description' => __( 'This option doesn\'t apply for two sidebars layout.', 'authow' ),
	'id'          => 'goso_single_custom_thumbnail_size',
...
$options[] = array(
	...
	'id'          => 'goso_enable_jarallax_single',
	'type'        => 'authow-fw-toggle',
...
$options[] = array(
	...
	'id'       => 'goso_dis_jarallax_single_mb',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
	...
	'id'       => 'goso_disable_autoplay_single_slider',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
	...
	'id'       => 'goso_disable_image_titles_galleries',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
	...
	'id'       => 'goso_disable_lightbox_single',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'     => false,
...
$options[] = array(
	...
	'id'          => 'goso_post_featured_image_radius',
	'type'        => 'authow-fw-text',
...
$options[] = array(
	...
	'id'          => 'goso_post_featured_image_ratio',
	'type'        => 'authow-fw-text',
...
$options[] = array(
	...
	'id'       => 'goso_off_letter_space_post_title',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
	...
	'id'       => 'goso_off_uppercase_post_title',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
...
$options[] = array(
	...
	'description' => esc_html__( 'Note that: If Published Date and Modified Date is the same - will be display Published date only. And if you want to display Modified date only - check option for it via Customize > General > General Settings > Display Modified Date Replace with Published Date', 'authow' ),
	'id'          => 'goso_single_publishmodified',
	'type'        => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
...
$options[] = array(
	...
	'id'       => 'goso_post_caption_disable_italic',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => 'style-1',
...
$options[] = array(
	...
	'id'          => 'goso_ads_inside_content_html',
	'description' => '',
...
$options[] = array(
	...
	'id'       => 'goso_ads_inside_content_style',
	'type'     => 'authow-fw-select',
	'choices'  => array(
...
$options[] = array(
	'default'  => '4',
	'sanitize' => 'absint',
	'label'    => __( 'Add Ads/Custom HTML Code Inside Posts Content After How Many Paragraphs?', 'authow' ),
	'id'       => 'goso_ads_inside_content_num',
	'type'     => 'authow-fw-size',
	'ids'      => array(
		'desktop' => 'goso_ads_inside_content_num',
	),
	'choices'  => array(
		'desktop' => array(
			'min'  => 1,
...
$options[] = array(
	...
	'id'          => 'goso_single_style_cscount',
	'description' => '',
	'type'        => 'authow-fw-select',
	'choices'     => $share_style
);
$options[] = array(
	'id'       => 'goso_post_align_cscount',
	'default'  => 'default',
	'sanitize' => 'goso_sanitize_choices_field',
...
$options[] = array(
	...
	'id'       => 'goso_off_uppercase_post_title_nav',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
...
$options[] = array(
	...
	'id'       => 'goso_post_remove_lines_related',
	'type'     => 'authow-fw-toggle',
);
$options[] = array(
	'default'  => false,
...
$options[] = array(
	'default'  => '150',
	'sanitize' => 'absint',
	'label'    => __( 'Custom the height of images on Justified Gallery style', 'authow' ),
	'id'       => 'goso_image_height_gallery',
	'type'     => 'authow-fw-size',
	'ids'      => array(
		'desktop' => 'goso_image_height_gallery',
	),
	'choices'  => array(
		'desktop' => array(
			'min'  => 1,
...
$options[] = array(
	...
	'id'          => 'goso_sidebar_left_name_single',
...
$options[] = array(
	'sanitize' => 'sanitize_text_field',
	'label'    => esc_html__( 'Ads on Single Posts', 'authow' ),
	'id'       => 'goso_singleads_bheading',
