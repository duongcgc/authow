function authowSetSettingValue(control, value) {
    "use strict";
    ...
    if ('authow-fw-toggle' === controlType) {
    ...
    } else if ('authow-fw-select' === controlType || 'authow-fw-preset' === controlType) {
    ...
    } else if ('authow-fw-slider' === controlType) {
    ...
    } else if ('authow-fw-generic' === controlType && undefined !== subControl.choices && undefined !== subControl.choices.element && 'textarea' === subControl.choices.element) {
    ...
    } else if ('authow-fw-color' === controlType) {

        alphaColorControl = container.find('.authow-fw-color-control');

        alphaColorControl.val(value).trigger('change');

        setting.set(value);

    } else if ('authow-fw-multicheck' === controlType) {
    ...
    } else if ('authow-fw-radio-buttonset' === controlType || 'authow-fw-radio-image' === controlType || 'authow-fw-radio' === controlType || 'authow-fw-dashicons' === controlType || 'authow-fw-color-palette' === controlType || 'authow-fw-palette' === controlType) {
    ...
    } else if ('authow-fw-typography' === controlType) {
        ...
        if (undefined !== value.color) {
            ...
            // Update the value visually in the control
            typographyColor = container.find('.authow-fw-color-control');
