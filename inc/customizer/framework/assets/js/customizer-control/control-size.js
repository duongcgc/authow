(function ($, api) {
    ...
    api.controlConstructor['authow-fw-size'] = api.controlConstructor.default.extend({
        ready: function () {
            'use strict';
            var control = this,
                value,
                ...
                inputDefault,
                changeAction,
                controlClass = '.customize-control-authow-fw-size',
    ...
    api.controlConstructor['authow-fw-hidden'] = api.controlConstructor.default.extend();
})(jQuery, wp.customize);
