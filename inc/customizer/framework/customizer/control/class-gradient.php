...
class Gradient extends Control_Abstract {
	 ...
	 * @var string
	 */
	public $type = 'authow-fw-gradient';
	...
	protected function content_template() {
		...
		<div class="wrapper">
			...
			<div class="authow-fw-range-end range">
			...
			<div class="color">
				<h5>Begin Color</h5>
				<input type="text" data-palette="{{ data.palette }}" data-default-color="{{ data.default['begincolor'] }}" value="{{ data.value['begincolor'] }}" class="authow-fw-color-control authow-fw-begin-color color-picker"/>
			</div>

			<div class="color">
				<h5>End Color</h5>
				<input type="text" data-palette="{{ data.palette }}" data-default-color="{{ data.default['endcolor'] }}" value="{{ data.value['endcolor'] }}" class="authow-fw-color-control authow-fw-end-color color-picker"/>
			</div>
