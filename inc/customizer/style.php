...
if ( ! function_exists( 'pencidesign_get_customizer_css_file' ) ):
	function pencidesign_get_customizer_css_file() {
		...
		if ( function_exists( 'penci_authow_list_self_fonts' ) ) {
			penci_authow_list_self_fonts();
		}
		if ( function_exists( 'penci_authow_add_custom_fonts' ) ) {
			penci_authow_add_custom_fonts();
		}
		...
		<?php if ( get_theme_mod( 'penci_enable_dark_layout' ) ): ?>
            ...
            .pcdark-mode .is-sticky #navigation, .pcdark-mode #navigation .menu .sub-menu, #navigation .menu .children,.pcdark-mode .penci-dropdown-menu{ box-shadow: 0px 1px 5px rgba(255, 255, 255, 0.08); -webkit-box-shadow: 0px 1px 5px rgba(255, 255, 255, 0.08); -moz-box-shadow: 0px 1px 5px rgba(255, 255, 255, 0.08); }
