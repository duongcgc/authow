...
function gosodesign_customize_register( $wp_customize ) {
	...
	class Goso_Customize_Heading_Control extends WP_Customize_Control {
		public $type = 'heading';
	...
	class Goso_Customize_List_Menus_Control extends WP_Customize_Control {
		...
		public function render_content() {
            ...
            <label>
                ...
                <select name="_customize-input-<?php echo $this->id; ?>"
                    ...
                    <option value=""><?php esc_html_e( '— Select —', 'authow' ); ?></option>
					<?php
	...
	class Goso_Customize_Control_Checkbox_Multiple extends WP_Customize_Control {
	...
	class WP_Customize_Category_Control extends WP_Customize_Control {
		public function render_content() {
			$dropdown = wp_dropdown_categories( array(
				...
				'echo'              => 0,
				'show_option_none'  => esc_html__( '- Select -', 'authow' ),
				'option_none_value' => '0',
				'selected'          => $this->value(),
			) );
...
/**
 * Add customize documentation for Authow
 *
 * @since 4.0
 *
 */
