    ...
    <div class="item">
        <div class="wrapper-item wrapper-item-classess">
			...
			while ( $feat_query->have_posts() ) : $feat_query->the_post();
				$thumb = $image_size;
				if ( $i % 7 == 1 && ! goso_is_mobile() ): $thumb = $image_size_big; endif;
				?>
                <div class="goso-item-mag goso-item-<?php echo( $i % 7 ); ?>">
                    ...
                    <div class="goso-slide-overlay goso-slider6-overlay">
                        ...
                        <div class="goso-mag-featured-content">
							<?php if ( ( $i % 7 == 1 || get_theme_mod( 'goso_featured_show_categories' ) ) && ! get_theme_mod( 'goso_featured_hide_categories' ) ): ?>
