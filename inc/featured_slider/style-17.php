...
$image_size_big      = get_theme_mod( 'featured_slider_imgbig' ) ? get_theme_mod( 'featured_slider_imgbig' ) : 'goso-magazine-slider';
	...
	$image_size_mobile = get_theme_mod( 'featured_slider_imgsize_mobile' ) ? get_theme_mod( 'featured_slider_imgsize_mobile' ) : 'goso-masonry-thumb';
    ...
    <div class="item">
        <div class="wrapper-item wrapper-item-classess">
			...
			while ( $feat_query->have_posts() ) : $feat_query->the_post();
				$thumb = $image_size;
                $bgset = goso_image_srcset( get_the_ID(),$thumb,$image_size_mobile );
				if ( $i % 5 == 3 ) {
                    $bgset = goso_image_srcset( get_the_ID(),$image_size_big,$image_size_mobile );
                }
				?>

				<?php if ( $i % 5 == 1 ): ?>
                    <div class="goso-slider17-mag-item goso-slide17-item-<?php echo( $i % 5 ); ?>">
				<?php endif; ?>

                <div class="goso-item-mag goso-item-<?php echo( $i % 5 ); ?>">
					...
					<?php } else { ?>
                        <a class="goso-image-holder"
                           style="background-image: url('<?php echo goso_get_featured_image_size( get_the_ID(), goso_is_mobile() ? $image_size_mobile : $thumb ); ?>');"
                           href="<?php the_permalink(); ?>"
                           title="<?php echo wp_strip_all_tags( get_the_title() ); ?>"></a>
					<?php } ?>
                    <div class="goso-slide-overlay goso-slider6-overlay">
                        ...
                        <div class="goso-mag-featured-content">
                            <div class="feat-text<?php if ( get_theme_mod( 'goso_featured_meta_date' ) ): echo ' slider-hide-date'; endif; ?>">
								<?php if ( ( $i % 5 == 3 || get_theme_mod( 'goso_featured_show_categories' ) ) && ! get_theme_mod( 'goso_featured_hide_categories' ) ): ?>
				...
				<?php if ( $i % 5 == 2 || $i % 5 == 3 ): ?>
                    </div><div class="goso-slider17-mag-item goso-slide17-item-<?php echo( $i % 5 ); ?>">
				<?php endif; ?>
