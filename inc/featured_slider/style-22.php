...
if ( goso_is_mobile() ) {
	$image_size_big = get_theme_mod( 'featured_slider_imgsize_mobile' ) ? get_theme_mod( 'featured_slider_imgsize_mobile' ) : 'goso-masonry-thumb';
	$image_size     = get_theme_mod( 'featured_slider_imgsize_mobile' ) ? get_theme_mod( 'featured_slider_imgsize_mobile' ) : 'goso-thumb-small';
}
?>
    ...
    <div class="item">
        <div class="wrapper-item wrapper-item-classess">
			...
			while ( $feat_query->have_posts() ) : $feat_query->the_post();
				$thumb = $image_size;
				if ( ( $i % 7 == 1 || $i % 7 == 2 ) && ! goso_is_mobile() ): $thumb = $image_size_big; endif;
				?>
                <div class="goso-item-mag goso-item-<?php echo( $i % 7 ); ?>">
