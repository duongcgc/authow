<?php
$class   = [];
$class[] = 'search-style-' . goso_get_builder_mod( 'goso_header_pb_search_form_sidebar_style' );
$class[] = goso_get_builder_mod( 'goso_header_pb_search_form_sidebar_menu_class' );
?>
<div class="goso-builder-element pc-search-form pc-search-form-sidebar <?php echo implode( ' ', $class ); ?>">
