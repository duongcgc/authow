<?php
$logo_settings = 'goso_header_pb_logo';
...
if ( 'image' == $logo_display ):
	?>
    <div class="pc-builder-element pc-logo pc-logo-desktop goso-header-image-logo <?php echo esc_attr( $logo_class ); ?>">
...
<?php else: ?>
    <div class="pc-builder-element pc-logo pc-logo-desktop goso-header-text-logo <?php echo esc_attr( $logo_class ); ?>">
        <a href="<?php echo $logo_url; ?>">
