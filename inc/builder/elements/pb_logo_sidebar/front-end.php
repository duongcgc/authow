<?php
$logo_settings = 'goso_header_pb_logo_sidebar';
...
if ( get_theme_mod( 'goso_mobile_nav_logo' ) ) {
	$logo_src = get_theme_mod( 'goso_mobile_nav_logo' );
}
...
if ( 'image' == $logo_display ):
	?>
    <div class="pc-builder-element pc-logo pb-logo-sidebar-mobile goso-header-image-logo <?php echo esc_attr( $logo_class ); ?>">
...
<?php else: ?>
    <div class="pc-builder-element pc-logo pb-logo-sidebar-mobile goso-header-text-logo <?php echo esc_attr( $logo_class ); ?>">
        <a href="<?php echo $logo_url; ?>">
