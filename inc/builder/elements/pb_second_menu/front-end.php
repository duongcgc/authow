<?php
$menu_id = goso_get_builder_mod( 'goso_header_pb_second_menu_name' );
if ( is_page() ) {
...
$classes[] = goso_get_builder_mod( 'goso_header_pb_second_menu_class', 'no-class' );
$classes[] = 'enable' == goso_get_builder_mod( 'goso_header_pb_second_menu_goso_header_enable_padding' ) ? 'menu-item-padding' : 'menu-item-normal';
$classes[] = 'enable' == goso_get_builder_mod( 'goso_header_pb_second_menu_goso_header_remove_line_hover' ) ? 'pcremove-lineh' : '';
