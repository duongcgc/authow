<?php
$logo_settings = 'goso_header_pb_logo_sticky';
...
if ( 'image' == $logo_display ):
	?>
    <div class="pc-builder-element pc-logo-sticky pc-logo goso-header-image-logo <?php echo esc_attr( $logo_class ); ?>">
...
<?php else: ?>
    <div class="pc-builder-element pc-logo pc-logo-sticky goso-header-text-logo <?php echo esc_attr( $logo_class ); ?>">
        <a href="<?php echo $logo_url; ?>">
