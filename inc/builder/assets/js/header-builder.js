!function (e, n) {
    ...
    function s() {
        n("[data-section^=goso]").on("click", (function () {
            !function (t) {
                var i = n(t),
                    o = i.data("section"),
                    r = "",
                    s = i.parents(".header-builder-device").data("device");
                if ("goso_header_ads" === o) r = "goso_ads_header_section";
                else if (a("goso_header_html", o)) r = "goso_header_html_section";
                else if (a("goso_header_button", o)) r = "goso_header_button_section";
                else if (a("goso_header_verticalmenu", o)) r = "goso_header_vertical_menu_section";
                else if (a("goso_header_search_icon", o)) {
                    if ("mobile" === s) return void d("goso_header_search_icon_section[goso_header_search_icon_mobile]");
                    r = o + "_section"
                } else r = o + "_section";
                var c = e.section(r);
                c && c.focus()
            }(this)
        })), n("[data-control^=goso]").on("click", (function () {
            d(this)
        }))
    }
    ...
    function v(e) {
        ...
        })), r(a[2], "goso_hb_element", a[0], a[1], t)
    }
    ...
    n((function () {
        t.on("goso-open-header-builder", l), n(".top-menu.close").on("click", (function () {
            u()
            ...
            if (!t.hasClass("active")) {
                var a = i(this),
                    o = t.data("align");
                h(a[2], a[0], a[1], o), r(a[2], "goso_hb_align", a[0], a[1], o)
            }
            ...
            if (!t.hasClass("active")) {
                var a = i(this),
                    o = t.data("display");
                _(a[2], a[0], a[1], o), r(a[2], "goso_hb_display", a[0], a[1], o)
            }
        ...
        })), n("#customize-header-actions").append("<div class='goso-btn-header-builder'><i class='fa fa-bars'></i></div>"), n(".goso-btn-header-builder").on("click", (function () {
