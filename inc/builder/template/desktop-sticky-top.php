<?php
$classes        = '';
$middle_content = goso_get_builder_mod( 'goso_header_sticky_top_middle_column', 'enable' );
$classes        .= 'enable' == $middle_content ? 'pcmiddle-center' : 'pcmiddle-normal';
$classes        .= goso_can_render_header( 'desktop_sticky', 'top' ) ? ' pc-hasel' : ' pc-noel';
$content_width  = goso_get_builder_mod( 'goso_header_sticky_top_content_width', 'container' );
?>
<div class="goso-desktop-sticky-top goso-sticky-top <?php echo esc_attr( $classes ); ?>">
    <div class="container <?php echo esc_attr( $content_width ); ?>">
        <div class="goso_nav_row">
			...
			foreach ( $columns as $column ) {
				$setting_align = "goso_hb_align_desktop_sticky_top_{$column}";
				$align         = goso_get_builder_mod( $setting_align, $column );

				$setting_element = "goso_hb_element_desktop_sticky_top_{$column}";
				$elements        = goso_get_builder_mod( $setting_element, goso_header_default( "sticky_element_top_{$column}" ) );
