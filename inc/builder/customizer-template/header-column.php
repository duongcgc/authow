<?php
$setting_align = "goso_hb_align_desktop_{$row}_{$column}";
$default_align = goso_get_builder_mod( $setting_align, 'normal' );

$setting_element = "goso_hb_element_desktop_{$row}_{$column}";
$default_element = goso_get_builder_mod( $setting_element, 'normal' );
