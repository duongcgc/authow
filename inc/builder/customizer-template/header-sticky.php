<div class="header-builder-sticky header-builder-sticky-<?php echo esc_html( $row ); ?> flex-row header-builder-row"
    ...
    <div class="header-builder-row-option" data-section="goso_header_desktop_sticky_<?php echo esc_html( $row ); ?>">
        <i class="fa fa-cog"></i> <?php echo esc_html__( 'Sticky Bar - ' . $row, 'authow' ); ?>
    </div>
	<?php
