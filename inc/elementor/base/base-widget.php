...
namespace GosoAuthowElementor\Base;
...
abstract class Base_Widget extends Widget_Base {
	...
	public function register_block_title_ajax_filter( $navigation = false, $condition = [] ) {
		$this->start_controls_section( 'biggrid_section_afilter', array(
			'label'     => __( 'Heading Ajax Filter', 'authow' ),
			'condition' => $condition
		) );

		$this->add_control( 'group_more_link_text', array(
			'label'   => __( 'Add Text Before More Icon', 'authow' ),
		...
		$this->add_control( 'biggrid_ajaxfilter_author', array(
			'type'        => Controls_Manager::SELECT2,
			'label'       => esc_html__( 'Post Author', 'authow' ),
			'options'     => $users,
			'label_block' => true,
			'multiple'    => true,
		) );
		...
		$this->add_control( 'biggrid_ajax_loading_style', array(
			...
			'label'   => esc_html__( 'Loading Icon Style', 'authow' ),
			'default' => 'df',
			'options' => [
				'df' => 'Follow Customize',
				's9' => 'Style 1',
		...
		if ( $navigation ) {
			$this->add_control( 'paging', array(
				'label' => __( 'Show Ajax Previous/Next Buttons', 'authow' ),
	...
	public function register_block_heading_link_section_style( $title = 'Heading Ajax Filter' ) {
		...
		$this->add_responsive_control( 'btn_group_nav_size', array(
			'label'     => __( 'Next/Prev Buttons Font Size', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 50, ) ),
			'selectors' => array(
		...
		$this->add_control( 'btn_group_link_hcolor', array(
			'label'     => __( 'Hover & Active Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'btn_group_dbgcolor', array(
			'label'     => __( 'Dropdown Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
				'{{WRAPPER}} .pcnav-lgroup ul ul' => 'background-color: {{VALUE}};',
			),
		) );
		$this->add_control( 'btn_group_dbdcolor', array(
			'label'     => __( 'Dropdown Borders Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'btn_group_droplhcolor', array(
			'label'     => __( 'Dropdown Hover & Active Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'btn_group_loading_icon', array(
			'label'     => __( 'Loading Icon Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
		...
		$this->add_control( 'btn_group_loading_bgcolor', array(
			'label'     => __( 'Loading Overlay Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'condition' => [ 'biggrid_ajax_loading_style!' => '' ],
			'selectors' => array(
		...
		$this->add_control( 'btn_group_loading_bgopacity', array(
			'label'     => __( 'Loading Overlay Background Opacity', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'condition' => [ 'biggrid_ajax_loading_style!' => '' ],
	...
	public function register_block_title_style_section_controls() {
		...
		$this->add_control( 'btitle_style78_bcolor', array(
			'label'     => __( 'Small Border Bottom on Style 7 & 8', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'btitle_shapes_color', array(
			'label'     => __( 'Background Color for Shapes', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'btitle_inshapes_color', array(
			'label'     => __( 'Background Color for Shapes Inside', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_responsive_control( 'iconstyle15_size', array(
			'label'       => __( 'Custom Font Size for Icon', 'authow' ),
			'type'        => Controls_Manager::SLIDER,
			'description' => __( 'For Icon on Style 15', 'authow' ),
		...
		$this->add_control( 'btitle_style9_repeat', array(
			'label'     => esc_html__( 'Background Image Repeat', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => array(
				'no-repeat' => esc_html__( 'No Repeat', 'authow' ),
				'repeat'    => esc_html__( 'Repeat', 'authow' ),
				'repeat-x'  => esc_html__( 'Repeat X', 'authow' ),
				'repeat-y'  => esc_html__( 'Repeat Y', 'authow' ),
			),
			'condition' => array( 'heading_title_style' => 'style-8' ),
			'default'   => 'no-repeat',
		...
		$this->add_control( 'btitle_style9_size', array(
			'label'     => esc_html__( 'Background Image Size', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => array(
				'auto 100%' => esc_html__( 'With Auto - Height 100%', 'authow' ),
				'100% auto' => esc_html__( 'Width 100% - Height Auto', 'authow' ),
				'cover'     => esc_html__( 'Cover', 'authow' ),
				'contain'   => esc_html__( 'Contain', 'authow' ),
				'auto'      => esc_html__( 'Orininal Size', 'authow' ),
			),
			'condition' => array( 'heading_title_style' => 'style-8' ),
			'default'   => 'auto 100%',
		...
		$this->add_control( 'btitle_style9_pos', array(
			'label'     => esc_html__( 'Background Image Position', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => array(
				'left top'      => esc_html__( 'Left Top', 'authow' ),
				'left center'   => esc_html__( 'Left Center', 'authow' ),
				'left bottom'   => esc_html__( 'Left Bottom', 'authow' ),
				'right top'     => esc_html__( 'Right Top', 'authow' ),
				'right center'  => esc_html__( 'Right Center', 'authow' ),
				'right bottom'  => esc_html__( 'Right Bottom', 'authow' ),
				'center top'    => esc_html__( 'Center Top', 'authow' ),
				'center center' => esc_html__( 'Center', 'authow' ),
				'center bottom' => esc_html__( 'Center Bottom', 'authow' ),
			),
			'condition' => array( 'heading_title_style' => 'style-8' ),
			'default'   => 'left top',
	...
	public function register_product_style() {
		...
		$this->add_control( 'product_cat_color', array(
			'label'     => __( 'Product Category Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_cat_hover_color', array(
			'label'     => __( 'Product Category Hover Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_inner_color', array(
			'label'     => __( 'Product Inner Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_bg_color', array(
			'label'     => __( 'Product Buttons Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_bg_hover_color', array(
			'label'     => __( 'Product Buttons Hover Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_txt_color', array(
			'label'     => __( 'Product Buttons Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_txt_hover_color', array(
			'label'     => __( 'Product Buttons Hover Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_txt_color_5', array(
			'label'     => __( 'Add to cart button color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_txt_hover_color_5', array(
			'label'     => __( 'Add to cart button hover color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_bg_color_5', array(
			'label'     => __( 'Add to cart button background color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_bg_hover_color_5', array(
			'label'     => __( 'Add to cart button hover background color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_border_color_5', array(
			'label'     => __( 'Add to cart button border color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_button_border_hover_color_5', array(
			'label'     => __( 'Add to cart button hover border color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'product_item_inner_align', array(
			'label'     => __( 'Product Inner Text Align', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => '',
			'options'   => array(
				'left'   => 'Left',
		...
		$this->add_control( 'products_design_stock_progress_bg_active_color', array(
			'label'     => __( 'Stock Bar Background Active Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'products_design_stock_progress_height', array(
			'label'     => __( 'Stock Bar Height', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100, ) ),
			'selectors' => array(
		...
		$this->start_controls_section( 'products_design_style_pagination', [
			'label' => esc_html__( 'Pagination Style', 'authow' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		] );

		$this->add_control( 'pagination_color', array(
			'label'     => __( 'Pagination Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_bcolor', array(
			'label'     => __( 'Pagination Border Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_bgcolor', array(
			'label'     => __( 'Pagination Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_hcolor', array(
			'label'     => __( 'Pagination Hover Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_hbcolor', array(
			'label'     => __( 'Pagination Border Hover Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_cicolor', array(
			'label'     => __( 'Pagination Current Item Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_bicolor', array(
			'label'     => __( 'Pagination Current Item Border Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_bgicolor', array(
			'label'     => __( 'Pagination Current Item Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_more_bgcolor', array(
			'label'     => __( 'Pagination View More Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_more_bghcolor', array(
			'label'     => __( 'Pagination View More Background Hover Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_more_textcolor', array(
			'label'     => __( 'Pagination View More Text Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'pagination_more_texthcolor', array(
			'label'     => __( 'Pagination View More Hover Text Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
