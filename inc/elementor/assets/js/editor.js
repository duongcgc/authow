	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = ElementEditorModule.extend({
			...
			fetchCache: function fetchCache(type, cacheKey, requestArgs) {
				...
				return elementorGoso.ajax.addRequest('forms_panel_action_data', {
...
// 19.1.2.9 / 15.2.3.2 Object.getPrototypeOf(O)
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		var ElementorGoso = Marionette.Application.extend({
			config: {},
			modules: {},
			...
			onStart: function onStart() {
				...
				this.config = GosoElementorConfig;
				this.initModules();
			...
			onElementorPreviewLoaded: function onElementorPreviewLoaded() {
				elementor.$preview[0].contentWindow.elementorGoso = this;
			},
			...
			onActivateSuccess: function onActivateSuccess() {
				...
				elementorGoso.config.isActive = true;
				elementor.notifications.showToast({
					message: elementor.translate('connected_successfully')
				});
			}
		});
		window.elementorGoso = new ElementorGoso();
		elementorGoso.start();
			...
			(0, _createClass2.default)(_default, [{
				...
				value: function onNavigatorInit() {
					elementor.navigator.indicators.customCSS = {
						...
						title: elementorGoso.translate('custom_css'),
			...
			(0, _createClass2.default)(_default, [{
				...
				value: function onNavigatorInit() {
					elementor.navigator.indicators.motionFX = {
						icon: 'flash',
						title: elementorGoso.translate('motion_effects'),
		...
		var PopupSave = /*#__PURE__*/function (_$e$modules$hookData$) {
			...
			(0, _createClass2.default)(PopupSave, [{
				...
				value: function apply() {
					var settings = {};
					jQuery.each(elementorGoso.modules.popup.displaySettingsTypes, function (type, data) {
						settings[type] = data.model.toJSON({
							remove: ['default']
						});
					});
					elementorGoso.ajax.addRequest('popup_save_display_settings', {
						data: {
							settings: settings
						}
					});
				...
				value: function getIntroduction() {
					return new elementorModules.editor.utils.Introduction({
						...
						dialogOptions: {
							...
							headerMessage: '<i class="eicon-info"></i>' + elementorGoso.translate('popup_settings_introduction_title'),
							message: elementorGoso.translate('popup_settings_introduction_message'),
							closeButton: true,
			...
			(0, _createClass2.default)(PopupAddLibraryTab, [{
				...
				value: function apply() {
					$e.components.get('library').addTab('templates/popups', {
						title: elementorGoso.translate('popups'),
						filter: {
							source: 'remote',
							type: 'popup'
						}
			...
			(0, _createClass2.default)(PopupAddTriggers, [{
				...
				value: function addPublishTabs() {
					var config = elementor.config.document.displaySettings,
						...
						module = elementorGoso.modules.popup;
					jQuery.each(module.displaySettingsTypes, function (type, data) {
						...
						component.addTab(type, {
							...
							name: type,
							title: elementorGoso.translate(type),
							description: elementorGoso.translate("popup_publish_screen_".concat(type, "_description")),
							image: elementorGoso.config.urls.modules + "popup/assets/images/".concat(type, "-tab.svg")
						});
					});
				}
			}, {
				...
				value: function addPanelFooterSubmenuItems() {
					var component = $e.components.get('theme-builder-publish'),
						displaySettingsTypes = elementorGoso.modules.popup.displaySettingsTypes;
				...
				value: function onRender() {
					...
					this.children.each(function (child) {
						...
						var $imageWrapper = jQuery('<div>', {
							...
							$image = jQuery('<img>', {
								src: elementorGoso.config.urls.modules + "popup/assets/images/".concat(name, "/").concat(groupName, ".svg")
							});
		...
		var PopupRemoveTriggers = /*#__PURE__*/function (_$e$modules$hookUI$Af) {
			...
			(0, _createClass2.default)(PopupRemoveTriggers, [{
				...
				value: function removePanelFooterSubmenuItems() {
					var displaySettingsTypes = elementorGoso.modules.popup.displaySettingsTypes;
			...
			(0, _createClass2.default)(Module, [{
				...
				value: function registerTemplateType() {
					elementor.templates.registerTemplateType('widget', {
						showInLibrary: false,
						saveDialog: {
							title: elementorGoso.translate('global_widget_save_title'),
							description: elementorGoso.translate('global_widget_save_description')
						},
				...
				value: function addSavedWidgetsToPanel() {
					...
					_.each(elementorGoso.config.widget_templates, function (templateArgs, id) {
			...
			(0, _createClass2.default)(Link, [{
				...
				value: function getHistory(args) {
					...
					return {
						...
						subTitle: data.title,
						type: elementorGoso.translate('linked_to_global')
					};
				}
			}, {
				key: "apply",
				value: function apply(args) {
					...
					containers.forEach(function (
						...
						var globalModel = elementorGoso.modules.globalWidget.addGlobalWidget(data.template_id, data),
			...
			(0, _createClass2.default)(Unlink, [{
				...
				value: function getHistory(args) {
					...
					return {
						...
						type: elementorGoso.translate('unlink_widget')
					};
				}
			}, {
				key: "apply",
				value: function apply(args) {
					...
					containers.forEach(function (
						/** Container */
						container) {
						var globalModel = elementorGoso.modules.globalWidget.getGlobalModels(container.model.get('templateID'));
						$e.run('document/elements/create', {
							container: container.parent,
							model: {
								id: elementor.helpers.getUniqueID(),
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		var GlobalWidgetSave = /*#__PURE__*/function (_$e$modules$hookData$) {
			...
			(0, _createClass2.default)(GlobalWidgetSave, [{
				...
				key: "apply",
				value: function apply() {
					elementorGoso.modules.globalWidget.saveTemplates();
				}
			}]);
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		GlobalWidgetView = WidgetView.extend({
			...
			initialize: function initialize() {
				...
				if (previewSettings) {
					...
					if (!globalSettingsLoadedStatus) {
						...
						elementorGoso.modules.globalWidget.requestGlobalModelSettings(globalModel, null, this.getContainer());
					}
			...
			getGlobalModel: function getGlobalModel() {
				if (!this.globalModel) {
					this.globalModel = elementorGoso.modules.globalWidget.getGlobalModels(this.model.get('templateID'));
				}
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = elementor.modules.elements.models.Element.extend({
			...
			getGlobalModel: function getGlobalModel() {
				...
				return elementorGoso.modules.globalWidget.getGlobalModels(templateID);
			},
			getTitle: function getTitle() {
				...
				var global = elementorGoso.translate('global');
		...
		module.exports = Marionette.ItemView.extend({
			...
			buildUnlinkDialog: function buildUnlinkDialog() {
				...
				return elementorCommon.dialogsManager.createWidget('confirm', {
					...
					headerMessage: elementorGoso.translate('unlink_widget'),
					message: elementorGoso.translate('dialog_confirm_unlink'),
					position: {
						my: 'center center',
						at: 'center center'
					},
					strings: {
						confirm: elementorGoso.translate('unlink'),
						cancel: elementorGoso.translate('cancel')
					},
			...
			onEditButtonClick: function onEditButtonClick() {
				...
				elementorGoso.modules.globalWidget.requestGlobalModelSettings(editedModel, function () {
		...
		var ThemeBuilderModule = /*#__PURE__*/function (_elementorModules$edi) {
			...
			(0, _createClass2.default)(ThemeBuilderModule, [{
				...
				value: function __construct() {
					...
					(0, _defineProperty.default)(elementorGoso.config, 'theme_builder', {
						get: function get() {
		...
		var _default = /*#__PURE__*/function (_elementorModules$com) {
			...
			(0, _createClass2.default)(_default, [{
				...
				value: function getLogoOptions() {
					return {
						title: elementorGoso.translate('publish_settings')
					};
				}
			}, {
				key: "initModal",
				value: function initModal() {
					...
					this.modal.addButton({
						name: 'publish',
						text: elementorGoso.translate('save_and_close'),
						callback: function callback() {
					...
					this.modal.addButton({
						name: 'next',
						text: elementorGoso.translate('next'),
						callback: function callback() {
		...
		var ThemeBuilderUpdatePreviewOptions = /*#__PURE__*/function (_$e$modules$hookData$) {
			...
			(0, _createClass2.default)(ThemeBuilderUpdatePreviewOptions, [{
				...
				value: function apply(args) {
					var _args$containers = args.containers,
						containers = _args$containers === void 0 ? [args.container] : _args$containers,
						themeBuilder = elementorGoso.modules.themeBuilder;
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		var ThemeBuilderSaveConditions = /*#__PURE__*/function (_$e$modules$hookData$) {
			...
			(0, _createClass2.default)(ThemeBuilderSaveConditions, [{
				...
				key: "apply",
				value: function apply() {
					var conditionsModel = elementorGoso.modules.themeBuilder.conditionsModel;
					elementorGoso.ajax.addRequest('theme_builder_save_conditions', {
			...
			(0, _createClass2.default)(ThemeBuilderAddEditorUI, [{
				...
				value: function addPublishTabs() {
					...
					component.addTab('conditions', {
						title: elementorGoso.translate('conditions'),
						View: _view.default,
						viewOptions: {
						...
						name: 'conditions',
						description: elementorGoso.translate('conditions_publish_screen_description'),
						image: elementorGoso.config.urls.modules + 'theme-builder/assets/images/conditions-tab.svg'
					});
				}
			}, {
				key: "addPanelFooterSubmenuItems",
				value: function addPanelFooterSubmenuItems() {
					...
					footerView.ui.menuConditions = footerView.addSubMenuItem('saver-options', {
						...
						name: 'conditions',
						icon: 'eicon-flow',
						title: elementorGoso.translate('display_conditions'),
						callback: function callback() {
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = elementor.modules.controls.Repeater.extend({
			...
			onRender: function onRender() {
				this.ui.btnAddRow.text(elementorGoso.translate('add_condition'));
			}
		});
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = elementor.modules.controls.RepeaterRow.extend({
			...
			checkConflicts: function checkConflicts() {
				...
				$error.remove();
				elementorGoso.ajax.addRequest('theme_builder_conditions_check_conflicts', {
					unique_id: rowId,
					data: {
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		var ThemeBuilderToggleMenuConditions = /*#__PURE__*/function (_$e$modules$hookUI$Af) {
			...
			(0, _createClass2.default)(ThemeBuilderToggleMenuConditions, [{
				...
				key: "apply",
				value: function apply() {
					var themeBuilder = elementorGoso.modules.themeBuilder;
				...
				value: function onPageStatusChange(newStatus) {
					...
					var options = {
						...
						buttons: [{
							...
							text: '<i class="eicon-external-link-square"></i><span class="e-theme-builder-toaster-button-text">' + elementorGoso.translate('open_site_editor') + '</span>',
							callback: function callback() {
								$e.run('app/open');
							}
						}, {
							name: 'view_live_site',
							text: '<i class="eicon-preview-medium"></i><span class="e-theme-builder-toaster-button-text">' + elementorGoso.translate('view_live_site') + '</span>',
							callback: function callback() {
			...
			var updateReplyToOptions = function updateReplyToOptions() {
				...
				emailFields = _.map(emailModels, function (model) {
					return {
						...
						label: elementorGoso.translate('x_field', [model.get('field_label')])
					};
				});
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = elementorModules.editor.utils.Module.extend({
			...
			getDataSettings: function getDataSettings(item) {
				var config = elementorGoso.config.forms[item.field_type],
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = elementor.modules.controls.Select2.extend({
			...
			getSelect2Placeholder: function getSelect2Placeholder() {
				return {
					id: '',
					text: elementorGoso.translate('all')
				};
			},
				...
				return jQuery.extend(elementor.modules.controls.Select2.prototype.getSelect2DefaultOptions.apply(this, arguments), {
					ajax: {
						transport: function transport(params, success, failure) {
							...
							return elementorGoso.ajax.addRequest(action, {
								data: data,
								success: success,
								error: failure
							});
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = elementorModules.editor.utils.Module.extend({
			config: elementorGoso.config.shareButtonsNetworks,
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = elementorModules.Module.extend({
			...
			getCustomFont: function getCustomFont(fontType, font) {
				elementorGoso.ajax.addRequest('assets_manager_panel_action_data', {
