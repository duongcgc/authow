	...
	function ( e, t, n ) {
		...
		e.exports = i.extend( {
			cache: {}, getName: function () {
				...
				var i = this;
				return authowElementor.ajax.addRequest( "forms_panel_action_data", {
		...
		var i = Marionette.Application.extend( {
			config: {}, modules: {}, initModules: function () {
				...
				this.config = GosoElementorConfig, this.initModules(), jQuery( window ).on( "elementor:init", this.onElementorInit )
			}, onElementorInit: function () {
				authowElementor.libraryRemoveGetProButtons(), elementor.debug.addURLToWatch( "elementor/assets" )
				...
				elementor.hooks.addFilter( "elementor/editor/template-library/template/action-button", function ( e, t ) {
					return t.isPro && !authowElementor.config.isActive ? "#tmpl-elementor-template-library-activate-license-button" : "#tmpl-elementor-template-library-insert-button"
				} )
			}
		} );
		window.authowElementor = new i, authowElementor.start()
	}, function ( e, t, n ) {
		"use strict";
		var i = n( 0 );
		e.exports = i.extend( {
		...
		e.exports = elementor.modules.controls.Select2.extend( {
			cache: null, isTitlesReceived: !1, getSelect2Placeholder: function () {
				return {id: "", text: authowElementor.translate( "all" )}
				...
				return jQuery.extend( elementor.modules.controls.Select2.prototype.getSelect2DefaultOptions.apply( this, arguments ), {
					ajax: {
						transport: function ( t, n, i ) {
							...
							return authowElementor.ajax.addRequest( "panel_posts_control_filter_autocomplete", {data: o, success: n, error: i} )
						}, data: function ( e ) {
		...
		e.exports = function () {
			var e, t, n, i = function () {
				...
				o = _.reject( o, {field_label: ""} ), e = _.map( o, function ( e ) {
					return {id: e.get( "_id" ), label: authowElementor.translate( "x_field", [e.get( "field_label" )] )}
		...
		e.exports = i.extend( {
			renderField: function ( e, t ) {
				var n = authowElementor.config.forms.recaptcha;
		...
		e.exports = i.extend( {
			globalModels: {}, panelWidgets: null, templatesAreSaved: !0, addGlobalWidget: function ( e, t ) {
				...
				elementor.templates.registerTemplateType( "widget", {
					showInLibrary: !1, saveDialog: {title: authowElementor.translate( "global_widget_save_title" ), description: authowElementor.translate( "global_widget_save_description" )}, prepareSavedData: function ( e ) {
				...
				var e = this;
				e.panelWidgets = new Backbone.Collection, _.each( authowElementor.config.widget_templates, function ( t, n ) {
				...
				elementor.history && elementor.history.history.startItem( {title: elementor.config.widgets[e.widgetType].title, type: authowElementor.translate( "linked_to_global" )} );
		...
		i = o.extend( {
			globalModel: null, className: function () {
				...
				if ( t ) {
					...
					r || (
						n.set( "settingsLoadedStatus", "pending" ), authowElementor.modules.globalWidget.requestGlobalModelSettings( n )
				...
				return this.globalModel || (
					this.globalModel = authowElementor.modules.globalWidget.getGlobalModels( this.model.get( "templateID" ) )
				), this.globalModel
				...
				var e = this.getGlobalModel();
				elementor.history.history.startItem( {title: e.getTitle(), type: authowElementor.translate( "unlink_widget" )} );
		...
		e.exports = elementor.modules.elements.models.Element.extend( {
			initialize: function () {
				...
				return authowElementor.modules.globalWidget.getGlobalModels( e )
			}, getTitle: function () {
				var e = this.getSetting( "_title" );
				e || (
					e = this.getGlobalModel().get( "title" )
				);
				var t = authowElementor.translate( "global" );
				return (
		...
		e.exports = Marionette.ItemView.extend( {
			...
			buildUnlinkDialog: function () {
				...
				return elementorCommon.dialogsManager.createWidget( "confirm", {
					...
					headerMessage: authowElementor.translate( "unlink_widget" ),
					message: authowElementor.translate( "dialog_confirm_unlink" ),
					position: {my: "center center", at: "center center"},
					strings: {confirm: authowElementor.translate( "unlink" ), cancel: authowElementor.translate( "cancel" )},
					onConfirm: function () {
			...
			onEditButtonClick: function () {
				...
				"loaded" !== t.get( "settingsLoadedStatus" ) ? (
					e.ui.loading.removeClass( "elementor-hidden" ), authowElementor.modules.globalWidget.requestGlobalModelSettings( t, function () {
		...
		var i = n( 0 );
		e.exports = i.extend( {
			config: authowElementor.config.shareButtonsNetworks, networksClassDictionary: {google: "fa fa-google-plus", pocket: "fa fa-get-pocket", email: "fa fa-envelope"}, getNetworkClass: function ( e ) {
		...
		e.exports = elementor.modules.Module.extend( {
			_enqueuedFonts: [], _enqueuedTypekit: !1, onFontChange: function ( e, t ) {
				...
				authowElementor.ajax.addRequest( "assets_manager_panel_action_data", {
		...
		e.exports = i.extend( {
			onElementorInit: function () {
				...
				if ( authowElementor.config.theme_builder ) {
					var t = n( 47 );
				...
				authowElementor.config.theme_builder && (
				...
				var e = n( 48 ), t = authowElementor.config.theme_builder, i = t.settings, o = new elementor.modules.elements.models.BaseSettings( i, {controls: t.template_conditions.controls} );
		...
		e.exports = elementor.modules.controls.Repeater.extend( {
			childView: i, updateActiveRow: function () {
				...
				elementor.modules.controls.Repeater.prototype.initialize.apply( this, arguments ), this.config = authowElementor.config.theme_builder, this.updateConditionsOptions( this.config.settings.template_type )
			}, checkConflicts: function ( e ) {
				var t = e.get( "_id" ), n = "elementor-condition-id-" + t, i = "elementor-conditions-conflict-message-" + t, o = jQuery( "#" + i );
				jQuery( "#" + n ).removeClass( "elementor-error" ), o.remove(), authowElementor.ajax.addRequest( "theme_builder_conditions_check_conflicts", {
				...
				var e = authowElementor.modules.themeBuilder.conditionsLayout.modalContent.currentView.ui, t = e.publishButton, n = e.publishButtonTitle;
				this.collection.length ? (
					t.addClass( "elementor-button-success" ), n.text( elementor.translate( "publish" ) )
				) : (
					t.removeClass( "elementor-button-success" ), n.text( authowElementor.translate( "save_without_conditions" ) )
				)
			}, onRender: function () {
				this.ui.btnAddRow.text( authowElementor.translate( "add_condition" ) );
				var e = this;
		...
		e.exports = elementor.modules.controls.RepeaterRow.extend( {
			template: "#tmpl-elementor-theme-builder-conditions-repeater-row", childViewContainer: ".elementor-theme-builder-conditions-repeater-row-controls", id: function () {
				...
				elementor.modules.controls.RepeaterRow.prototype.initialize.apply( this, arguments ), this.config = authowElementor.config.theme_builder
		...
		e.exports = i.extend( {
			ui: function () {
				...
				var e = jQuery( "<div>", {id: "elementor-panel-saver-conditions", class: "elementor-panel-footer-sub-menu-item", html: '<i class="elementor-icon fa fa-paper-plane"></i><span class="elementor-title">' + authowElementor.translate( "display_conditions" ) + "</span>"} );
				...
				this.ui.menuConditions.toggle( !!authowElementor.config.theme_builder.settings.location )
			}, onChangeLocation: function ( e ) {
				_.isUndefined( e.changed.location ) || (
					authowElementor.config.theme_builder.settings.location = e.changed.location, this.toggleMenuConditions()
				)
			}, onClickMenuConditions: function () {
				authowElementor.modules.themeBuilder.showConditionsModal()
			}, onClickButtonPublish: function () {
				var e = authowElementor.config.theme_builder.settings.conditions.length, t = authowElementor.config.theme_builder.settings.location, n = "draft" === elementor.settings.page.model.get( "post_status" );
				e && !n || !t ? i.prototype.onClickButtonPublish.apply( this, arguments ) : authowElementor.modules.themeBuilder.showConditionsModal()
		...
		e.exports = i.extend( {
			id: "elementor-theme-builder-conditions-view", template: "#tmpl-elementor-theme-builder-conditions-view", childViewContainer: "#elementor-theme-builder-conditions-controls", ui: function () {
				...
				return {title: authowElementor.translate( "conditions_title" ), description: authowElementor.translate( "conditions_description" )}
				...
				e.stopPropagation(), n.attr( "disabled", !0 ).addClass( "elementor-button-state" ), authowElementor.ajax.addRequest( "theme_builder_save_conditions", {
					data: i, success: function () {
						authowElementor.config.theme_builder.settings.conditions = t.model.get( "conditions" ), elementor.saver.publish()
					}, complete: function () {
						t.afterAjax( n )
					}
				} )
			}, afterAjax: function ( e ) {
				e.attr( "disabled", !1 ).removeClass( "elementor-button-state" ), authowElementor.modules.themeBuilder.conditionsLayout.modal.hide()
			}
		} )
	}, function ( e, t, n ) {
		"use strict";
		...
		e.exports = i.extend( {
			getModalOptions: function () {
				...
				return {title: authowElementor.translate( "display_conditions" )}
			}, initialize: function () {
