...
namespace GosoAuthowElementor\Modules\QueryControl;
...
use GosoAuthowElementor\Modules\QueryControl\Controls\Query;
...
class Module extends Module_Base {
	...
	public static function add_exclude_controls( $widget ) {
		...
		$widget->add_control( 'exclude', array(
			'label'       => __( 'Exclude', 'authow' ),
			'type'        => Controls_Manager::SELECT2,
			'multiple'    => true,
			'options'     => array(
				'current_post'     => __( 'Current Post', 'authow' ),
				'manual_selection' => __( 'Manual Selection', 'authow' )
			),
			'label_block' => true,
	...
	public function register_controls( $controls_manager ) {
		...
		$controls_manager->add_group_control( Goso_Group_Control_Posts::get_type(), new Goso_Group_Control_Posts() );
