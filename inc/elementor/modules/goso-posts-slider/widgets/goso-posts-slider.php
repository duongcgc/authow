...
namespace GosoAuthowElementor\Modules\GosoPostsSlider\Widgets;
...
class GosoPostsSlider extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'dis_lazyload', array(
				'label'   => __( 'Disable lazyload ?', 'authow' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			) );
		$this->add_control( 'enable_autoplay', array(
				'label'   => __( 'Enable Autoplay Slider?', 'authow' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			) );
