...
namespace GosoAuthowElementor\Modules\GosoAuthorList\Widgets;
...
class GosoAuthorList extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'roles', array(
			'label'    => __( 'Select User Roles', 'authow' ),
		...
		$this->add_control( 'excluded', array(
			'label' => __( 'Exclude User IDs:', 'authow' ),
			'type'  => Controls_Manager::TEXT,
		) );

		$this->add_control( 'avatar', array(
			'label' => __( 'Hide user avatar?', 'authow' ),
		...
		$this->add_control( 'post_count', array(
			'label' => __( 'Hide user posts count?', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );
		...
		$this->add_responsive_control( 'author_spacing', array(
			'label'      => __( 'Spacing Between Authors', 'authow' ),
		...
		$this->add_group_control( Group_Control_Typography::get_type(), array(
			...
			'label'    => __( 'Post Count Typography', 'authow' ),
