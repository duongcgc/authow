...
namespace GosoAuthowElementor\Modules\GosoProductBrand\Widgets;
 ...
 * @since 1.0.0
 */
class GosoProductBrand extends Base_Widget {
	/**
	 * Get widget name.
	 *
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => array(
					...
					'term_id' => esc_html__( 'ID', 'authow' ),
					'slug'    => esc_html__( 'Slug', 'authow' ),
					'random'  => esc_html__( 'Random order', 'authow' ),
				),
			]
		);
		...
		$this->add_control(
			'hover',
			[
				'label'   => esc_html__( 'Brand images hover', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => array(
		...
		$this->add_control(
			'brand_style',
			[
				'label'   => esc_html__( 'Border Style ?', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => array(
					'default'  => esc_html__( 'No', 'authow' ),
					'bordered' => esc_html__( 'Yes', 'authow' ),
				),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => array(
					...
					'list'     => esc_html__( 'Links List', 'authow' ),
				),
			]
		);
		...
		$this->start_controls_section(
			'brand_style_section',
			[
				'label' => esc_html__( 'Brand Style', 'authow' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'brand_text_color', array(
				'label'     => __( 'Brand Text Color', 'authow' ),
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), array(
				...
				'label'     => __( 'Brand Text Typography', 'authow' ),
		...
		$this->add_control(
			'carousel_border_color', array(
				'label'     => __( 'Carousel Navigation <br> Border Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			'carousel_bg_color', array(
				'label'     => __( 'Carousel Navigation <br> Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			'carousel_border_active_color', array(
				'label'     => __( 'Carousel Navigation <br> Active Border Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			'carousel_bg_active_color', array(
				'label'     => __( 'Carousel Navigation <br> Active Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
