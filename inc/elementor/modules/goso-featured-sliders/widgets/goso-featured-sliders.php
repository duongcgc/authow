...
namespace GosoAuthowElementor\Modules\GosoFeaturedSliders\Widgets;
...
class GosoFeaturedSliders extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'title_length', array(
			'label'     => __( 'Post Title Length', 'authow' ),
		...
		$this->add_control( 'cs_vertical_align', array(
			'label'       => __( 'Content Vertical Align', 'authow' ),
		...
		$this->add_control( 'cs_horizontal_align', array(
			'label'       => __( 'Horizontal Align', 'authow' ),
			'type'        => Controls_Manager::CHOOSE,
			'label_block' => false,
			'options'     => array(
				'left'   => array(
		...
		$this->start_controls_section( 'spacingitems_settings_section', array(
			'label' => __( 'Content Spacing', 'authow' ),
			'tab'   => Controls_Manager::TAB_CONTENT
		) );
		...
		$this->add_responsive_control( 'csct_bspacing', array(
			'label'     => __( 'Content Padding for Big Posts', 'authow' ),
			'type'      => Controls_Manager::DIMENSIONS,
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
		...
		$this->add_control( 'cspd_bigpost', array(
			'label'     => __( 'Spacing for Big Posts', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => array( 'style' => $big_post_lists ),
		) );
		...
		$this->add_responsive_control( 'csprvnxt_bspacing', array(
			'label'     => __( 'Slider Prev/Next Buttons Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors' => array(
		...
		$this->add_control( 'dots_csspc_w', array(
			'label'     => __( 'Slider Dots Spacing', 'authow' ),
			'separator' => 'before',
			'type'      => Controls_Manager::SLIDER,
		...
		$this->start_controls_section( 'section_design_sliderdosnav', array(
			'label' => __( 'Slider Controls', 'authow' ),
			'tab'   => Controls_Manager::TAB_STYLE
		) );
