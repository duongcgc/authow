    ...
    <div class="item">
        <div class="wrapper-item wrapper-item-classess">
			...
			while ( $feat_query->have_posts() ) : $feat_query->the_post();
				...
				?>
                <div class="goso-item-mag goso-item-<?php echo( $i % 7 ); ?>  <?php echo( ( $i % 7 == 1 || $i % 7 == 2 ) ? 'goso-pitem-big' : 'goso-pitem-small' ) ?>">
					<?php if ( ! $disable_lazyload ) { ?>
                        <a class="goso-image-holder <?php echo goso_classes_slider_lazy(); ?>"
                           ...
                           data-src="<?php echo goso_get_featured_image_size( get_the_ID(), $thumb ); ?>"
