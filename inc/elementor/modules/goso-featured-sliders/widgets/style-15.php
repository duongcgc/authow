    ...
    <div class="item">
        <div class="wrapper-item wrapper-item-classess">
			...
			while ( $feat_query->have_posts() ) : $feat_query->the_post();
				...
				?>
                <div class="goso-item-mag goso-item-<?php echo( $i % 3 ); ?> <?php echo( 2 == $i % 3 ? 'goso-pitem-big' : 'goso-pitem-small' ) ?>">
					<?php if ( ! $disable_lazyload ) { ?>
                        <a class="goso-image-holder <?php echo goso_classes_slider_lazy(); ?>"
                           data-bgset="<?php echo goso_image_srcset( get_the_ID(),$post_thumb_size,$thumb_mobile ); ?>"
