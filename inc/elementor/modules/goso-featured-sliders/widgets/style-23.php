...
$bpost_thumb_size = ! empty( $bpost_thumb_size ) ? $bpost_thumb_size : 'goso-thumb';
    ...
    <div class="item">
        <div class="wrapper-item wrapper-item-classess">
			...
			while ( $feat_query->have_posts() ) : $feat_query->the_post();
				...
				?>
                <div class="goso-item-mag goso-item-<?php echo( $i % 6 ); ?> <?php echo( ( $i % 6 == 1 || $i % 6 == 2 ) ? 'goso-pitem-big' : 'goso-pitem-small' ) ?>">
