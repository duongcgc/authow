...
namespace GosoAuthowElementor\Modules\GosoSmallList\Widgets;
...
class GosoSmallList extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control( 'hgap', array(
			'label'     => __( 'Horizontal Space Between Posts', 'authow' ),
		...
		$this->add_responsive_control( 'vgap', array(
			'label'     => __( 'Vertical Space Between Posts', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors' => array(
		...
		$this->add_control( 'date_pos', array(
			'label'     => __( 'Post Date Position', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => array(
				'left'  => 'Left',
				'right' => 'Right',
		...
		$this->add_control( 'date_align', array(
			'label'       => __( 'Post Date Align', 'authow' ),
			'type'        => Controls_Manager::CHOOSE,
			'label_block' => false,
			'options'     => array(
				'left'   => array(
		...
		$this->add_responsive_control( 'datewidth', [
			'label'      => __( 'Post Date Width', 'authow' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ '%', 'px' ],
			'range'      => [
				'px' => [
		...
		$this->add_control( 'show_excerpt', array(
			'label'        => __( 'Show The Post Excerpt?', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'excerpt_align', array(
			'label'       => __( 'Custom Excerpt Align', 'authow' ),
			'type'        => Controls_Manager::CHOOSE,
			'condition'   => array( 'show_excerpt' => 'yes' ),
			'label_block' => false,
			'options'     => array(
		...
		$this->add_control( 'rmstyle', array(
			'label'     => __( 'Read More Button Style', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => array(
				'filled'    => 'Default',
				'bordered'  => 'Bordered',
		...
		$this->add_control( 'rm_align', array(
			'label'       => __( 'Custom Read More Align', 'authow' ),
			'type'        => Controls_Manager::CHOOSE,
			'label_block' => false,
			'condition'   => array( 'show_readmore' => 'yes' ),
			'options'     => array(
		...
		$this->add_control( 'excerpt_pos', array(
			'label'      => __( 'Excerpt & Read More Position', 'authow' ),
			'type'       => Controls_Manager::SELECT,
			'options'    => array(
		...
		$this->add_control( 'hide_rm_mobile', array(
			'label'        => __( 'Hide Post Read More Button on Mobile', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'return_value' => 'yes',
			'default'      => '',
			'condition'    => array( 'show_readmore' => 'yes' ),
		...
		$this->add_control( 'item_bg', array(
			'label'     => __( 'Post Items Background Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
		...
		$this->add_responsive_control( 'item_padding', array(
			'label'      => __( 'Post Items Padding', 'authow' ),
		...
		$this->add_control( 'item_borders', array(
			'label'     => __( 'Add Borders for Post Items', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
		...
		$this->add_responsive_control( 'item_bordersw', array(
			'label'      => __( 'Post Items Borders Width', 'authow' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%', 'em' ),
			'selectors'  => array(
		...
		$this->add_control( 'heading_date', array(
			'label'     => __( 'Post Date ( for "Creative List" layout )', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => array( 'type' => array( 'nlist' ) ),
		) );
		...
		$this->add_control( 'rm_hbdcolor', array(
			'label'     => __( 'Hover Borders Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'condition' => array( 'rmstyle' => array( 'bordered', 'underline' ) ),
		...
		$this->add_responsive_control( 'excerpt_space', array(
			'label'     => __( 'Post Excerpt Margin Top', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'condition' => array( 'show_excerpt' => 'yes' ),
			'selectors' => array(
		...
		$this->start_controls_section( 'pagi_design', array(
			'label'     => __( 'Page Navigation', 'authow' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => array(
				'paging!' => 'none',
				'type!'   => 'crs',
	...
	protected function render() {
		...
		if ( 'none' !== 'paging' ) {
			...
			\Authow_VC_Shortcodes::get_block_script( $settings['blockid'], $ajax_data );
		}
