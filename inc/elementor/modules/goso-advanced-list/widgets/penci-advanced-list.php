...
namespace GosoAuthowElementor\Modules\GosoAdvancedList\Widgets;
 ...
 * @since 1.0.0
 */
class GosoAdvancedList extends Base_Widget {
	/**
	 * Get widget name.
	 *
	...
	protected function register_controls() {
		...
		$this->add_control(
			'general_label_style', array(
				'label'   => __( 'General Label Style:', 'authow' ),
		...
		$this->add_control(
			'general_heading_style', array(
				'label'   => __( 'Heading Title Style:', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'style-1',
				'options' => array(
					'style-1' => esc_html__( 'Style 1', 'authow' ),
		...
		$this->add_control(
			'item_col', array(
				'label'   => __( 'Split list menu items in columns?', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '1',
				'options' => array(
					'1' => esc_html__( 'No - Keep in 1 Column', 'authow' ),
		...
		$this->add_control(
			'item_col_space',
			[
				'label'     => esc_html__( 'Spacing Between Columns', 'authow' ),
		...
		$this->add_control(
			'menu_title_spacing',
			[
				'label'     => esc_html__( 'Spacing Between Title and List', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
				'selectors' => array(
		...
		$this->add_control(
			'menu_list_spacing',
			[
				'label'     => esc_html__( 'Spacing Between Item Lists', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
				'selectors' => array(
		...
		$this->start_controls_section(
			'general_section',
			[
				'label' => esc_html__( 'Custom List Items', 'authow' ),
			]
		);
		...
		$this->start_controls_tab(
			'label_tab',
			[
				'label' => esc_html__( 'Label', 'authow' ),
			]
		);

		$this->add_control(
			'label_style', array(
				'label'   => __( 'Label Style:', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => array(
					''        => esc_html__( 'Default From General', 'authow' ),
					'style-1' => esc_html__( 'Style 1', 'authow' ),
					'style-2' => esc_html__( 'Style 2', 'authow' ),
					'style-3' => esc_html__( 'Style 3', 'authow' ),
					'style-4' => esc_html__( 'Style 4', 'authow' ),
		...
		$this->add_control(
			'label',
			[
				'label' => esc_html__( 'Label text (optional)', 'authow' ),
				'type'  => Controls_Manager::TEXT,
			]
		);
		...
		$this->add_control(
			'label_color',
			[
				'label'     => esc_html__( 'Label Background Color', 'authow' ),
		...
		$this->add_control(
			'label_text_color',
			[
				'label'     => esc_html__( 'Label Text Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			'header_line_color',
			[
				'label'     => esc_html__( 'Heading Title Line Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Heading Title Small Line Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'menu_title_color',
			[
				'label'     => esc_html__( 'Menu Title color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Menu Title Hover color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), array(
				'name'     => 'menu_item_typo',
				'label'    => __( 'Menu Item Typography', 'authow' ),
		...
		$this->add_control(
			'menu_item_color',
			[
				'label'     => esc_html__( 'Menu Item Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Menu Item Hover Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
