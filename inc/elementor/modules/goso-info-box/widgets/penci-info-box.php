...
namespace GosoAuthowElementor\Modules\GosoInfoBox\Widgets;
...
class GosoInfoBox extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'image_hover',
			array(
				'label'     => __( 'Choose Image Hover', 'authow' ),
				'type'      => Controls_Manager::MEDIA,
				'condition' => array( 'icon_type' => 'image' ),
			)
		);
		...
		$this->add_control(
			'icon_view', array(
				'label'     => __( 'View', 'authow' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'default',
				'condition' => array( 'icon_type' => array( 'icon', 'svg', 'text' ) ),
				'options'   => array(
					'default' => esc_html__( 'Default', 'authow' ),
					'stacked' => esc_html__( 'Stacked', 'authow' ),
					'framed'  => esc_html__( 'Framed', 'authow' )
				)
			)
		);
		$this->add_control(
		...
		$this->add_control(
			'icon_hover_animation', array(
				'label'     => __( 'Hover Animation', 'authow' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'condition' => array( 'icon_view' => array( 'stacked', 'framed' ) ),
				'options'   => array(
					''             => esc_html__( 'None', 'authow' ),
					'grow'         => esc_html__( 'Grow', 'authow' ),
					'shrink'       => esc_html__( 'Shrink', 'authow' ),
					'pulse'        => esc_html__( 'Pulse', 'authow' ),
					'pulse-grow'   => esc_html__( 'Pulse Grow', 'authow' ),
					'pulse-shrink' => esc_html__( 'Pulse Shrink', 'authow' ),
					'push'         => esc_html__( 'Push', 'authow' ),
					'pop'          => esc_html__( 'Pop', 'authow' ),
					'custom-1'     => esc_html__( 'Custom Style 1', 'authow' ),
					'custom-2'     => esc_html__( 'Custom Style 2', 'authow' ),
					'custom-3'     => esc_html__( 'Custom Style 3', 'authow' ),
					'custom-4'     => esc_html__( 'Custom Style 4', 'authow' ),
					'custom-5'     => esc_html__( 'Custom Style 5', 'authow' )
				),
			)
		);
		...
		$this->add_control(
			'icon_position', array(
				...
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'top-left'    => __( 'Top left', 'authow' ),
					'top-center'  => __( 'Top center', 'authow' ),
					'top-right'   => __( 'Top right', 'authow' ),
					'float-left'  => __( 'Float left', 'authow' ),
					'float-right' => __( 'Float right', 'authow' ),
				),
				'default' => 'float-left',
			)
		);
		...
		$this->add_responsive_control(
			'icon_width', array(
				'label'     => __( 'Width/Height for Box Contain Icon', 'authow' ),
		...
		$this->add_control(
			'_use_line', array(
				'label'     => __( 'Use Line Below The Title', 'authow' ),
		...
		$this->add_control(
			'description_text', array(
				...
				'default'     => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'authow' ),
		...
		$this->add_control(
			'wraplink', array(
				'label'     => __( 'Wrap Link for Whole Info Box?', 'authow' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => __( 'Yes', 'authow' ),
				'label_off' => __( 'No', 'authow' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'icon_marbt', array(
				'label'     => __( 'Margin Bottom for Box Contain Icon', 'authow' ),
				'label_block' => true,
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
		...
		$this->add_responsive_control(
			'icon_marleft', array(
				'label'     => __( 'Margin Left for Box Contain Icon', 'authow' ),
				'label_block' => true,
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
		...
		$this->add_responsive_control(
			'icon_marright', array(
				'label'     => __( 'Margin Right for Box Contain Icon', 'authow' ),
				'label_block' => true,
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Typography & Colors', 'authow' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_responsive_control(
			'ibpadding', array(
				'label'      => __( 'Infor Box Padding', 'authow' ),
		...
		$this->add_responsive_control(
			'ibbdradius', array(
				'label'      => __( 'Infor Box Borders Radius', 'authow' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
		...
		$this->add_control(
			'picon_bgcolor',
			array(
				'label'     => __( 'Icon Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'condition' => array( 'icon_view' => array( 'stacked', 'framed' ) ),
				'selectors' => array(
		...
		$this->add_control(
			'picon_border_color',
			array(
				'label'     => __( 'Icon Border Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'condition' => array( 'icon_view' => array( 'stacked', 'framed' ) ),
				'selectors' => array(
		...
		$this->add_control(
			'picon_hbgcolor',
			array(
				'label'     => __( 'Icon Hover Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'condition' => array( 'icon_view' => array( 'stacked', 'framed' ) ),
				'selectors' => array(
		...
		$this->add_control(
			'picon_border_hcolor',
			array(
				'label'     => __( 'Icon Hover Border Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'condition' => array( 'icon_view' => array( 'stacked', 'framed' ) ),
				'selectors' => array(
		...
		$this->add_responsive_control(
			'picon_fsize', array(
				'label'     => __( 'Font Size for Icon/SVG', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'picon_padding', array(
				'label'      => __( 'Custom Icon Padding', 'authow' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', 'em' ),
				'condition' => array( 'icon_view' => array( 'stacked', 'framed' ) ),
				'selectors'  => array(
