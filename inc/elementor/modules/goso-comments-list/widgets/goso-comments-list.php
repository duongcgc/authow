...
namespace GosoAuthowElementor\Modules\GosoCommentsList\Widgets;
...
class GosoCommentsList extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'length', array(
			'label'   => __( 'Custom Comment Content Words Length:', 'authow' ),
			'type'    => Controls_Manager::NUMBER,
			'default' => 12,
		) );
		...
		$this->add_control( 'avatar_bradius', array(
			'label'      => __( 'Avatar Border Radius:', 'authow' ),
		...
		$this->add_responsive_control( 'comment_spacing', array(
			'label'          => __( 'Spacing Between Comments', 'authow' ),
			'type'           => Controls_Manager::SLIDER,
			'size_units'     => [ 'px' ],
			'range'          => array(
				'px' => array( 'max' => 200 ),
