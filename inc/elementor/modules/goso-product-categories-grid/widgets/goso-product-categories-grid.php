...
namespace GosoAuthowElementor\Modules\GosoProductCategoriesGrid\Widgets;
 ...
 * @since 1.0.0
 */
class GosoProductCategoriesGrid extends Base_Widget {
	/**
	 * Get widget name.
	 *
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Categories Query', 'authow' ),
			]
		);
		...
		$this->add_control(
			'taxonomy_image',
			[
				'label'   => esc_html__( 'Get image of taxonomy from', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => array(
					'latest' => esc_html__( 'Latest Post', 'authow' ),
					'random' => esc_html__( 'Random Post', 'authow' ),
					'view'   => esc_html__( 'Most View Post', 'authow' ),
					'field'  => esc_html__( 'Custom Term Field', 'authow' ),
				),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Taxonomy view meta key', 'authow' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Taxonomy image field name', 'authow' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => '',
		...
		$this->add_control(
			'style', array(
				'label'   => __( 'Categories Grid Style', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'style-1',
				'options' => array(
		...
		$this->add_control(
			'hide_subtitle', array(
				'label'        => __( 'Hide Category Count', 'authow' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'hide_subtitle_mobile', array(
				'label'        => __( 'Hide Category Count on Mobile', 'authow' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'authow' ),
				'label_off'    => __( 'No', 'authow' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'bgcontent_pos', array(
				'label'     => __( 'Categories Grid Content Position', 'authow' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'on',
				'options'   => array(
		...
		$this->add_responsive_control(
			'bg_height', array(
				'label'     => __( 'Custom Categories Grid Height (Unit is px)', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Quick Text Translate', 'authow' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			)
		);
		...
		$this->add_control(
			'text_item',
			array(
				'label'   => esc_html__( 'Text: % Item', 'authow' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '% item',
			)
		);
		...
		$this->add_control(
			'text_items',
			array(
				'label'   => esc_html__( 'Text: % Items', 'authow' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '% items',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Categories Grid Overlay', 'authow' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			'apply_spe_bg_meta', array(
				'label' => __( 'Apply Separate Background for Category Count', 'authow' ),
				'type'  => Controls_Manager::SWITCHER,
			)
		);
		...
		$this->add_control(
			'spe_bg_meta', array(
				'label'     => __( 'Background for Category Count', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			'spe_bg_hmeta', array(
				'label'     => __( 'Background for Category Count on Hover', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Categories Grid Typography & Colors', 'authow' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			'bgitem_design',
			array(
				'label'     => esc_html__( 'Categories Grid Items', 'authow' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'title_design',
			array(
				'label'     => esc_html__( 'Category Title', 'authow' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'desc_design',
			array(
				'label'     => esc_html__( 'Category Count', 'authow' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
