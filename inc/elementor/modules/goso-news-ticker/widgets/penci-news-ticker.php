<?php
namespace GosoAuthowElementor\Modules\GosoNewsTicker\Widgets;
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_layout', array(
				'label' => esc_html__( 'Display', 'authow' ),
		...
		$this->add_control(
			'tpost_text', array(
				'label'   => __( 'Custom "Top Posts" Text', 'authow' ),
		...
		$this->add_control(
			'headline_upper', array(
				'label'     => __( 'Turn off Uppercase for "Top Posts" text', 'authow' ),
				'type'      => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'autoplay', array(
				'label'     => __( 'Disable Auto Play', 'authow' ),
				'type'      => Controls_Manager::SWITCHER
			)
		);
		...
		$this->add_control(
			'headline_anim', array(
				'label'   => __( 'Transition Animation', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => array(
					''  => 'Slide In Up',
		...
		$this->add_control(
			'heading_tpostsec',
			array(
				'label'     => __( '"Top Posts" Section', 'authow' ),
		...
		$this->add_control(
			'tpost_bg',
			array(
				'label'     => __( '"Top Posts" Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array( 
		...
		$this->add_control(
			'tpost_color',
			array(
				'label'     => __( '"Top Posts" Text Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array( 
		...
		$this->add_control(
			'navs_bg',
			array(
				'label'     => __( 'Next/Prev Buttons Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'navs_hbg',
			array(
				'label'     => __( 'Next/Prev Buttons Hover Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'condition' => array( 'navs_buttons' => 'yes' ),
				'selectors' => array(
