...
namespace GosoAuthowElementor\Modules\GosoLatestPosts\Widgets;
...
class GosoLatestPosts extends Base_Widget {

	public function get_name() {
		return 'goso-latest-posts';
	}

	public function get_title() {
		return goso_get_theme_name('Goso').' '.esc_html__( ' Latest Posts', 'authow' );
	}
	...
	public function get_script_depends() {
		return [ 'goso_ajax_filter_latest' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'goso_mixed_style', array(
		...
		$this->add_responsive_control( 'goso_items_martop', array(
		...
		$this->add_control( 'goso_items_marlr', array(
			'label'          => __( 'Horizontal Gap Between Post Items', 'authow' ),
			'type'           => Controls_Manager::SLIDER,
			'default'        => array( 'size' => '' ),
			'mobile_default' => [
				'size' => 0
			...
			'range'          => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors'      => array(
				'(desktop+) {{WRAPPER}} .goso-grid > li:not(.grid-2-style)'                   => 'width:calc(33.3333333333% - {{SIZE}}{{UNIT}} + calc({{SIZE}}{{UNIT}}/3));margin-right : {{SIZE}}{{UNIT}}',
				'(desktop+) {{WRAPPER}} .goso-grid > li.grid-2-style'                         => 'width:calc(50% - {{SIZE}}{{UNIT}} + calc({{SIZE}}{{UNIT}}/2));margin-right : {{SIZE}}{{UNIT}}',
				'(desktop+) {{WRAPPER}} .goso-wrap-masonry'                                   => 'margin-left:calc({{SIZE}}{{UNIT}}/2*-1);margin-right:calc({{SIZE}}{{UNIT}}/2*-1)',
				'(desktop+) {{WRAPPER}} .goso-masonry .item-masonry'                          => 'padding-left:calc({{SIZE}}{{UNIT}}/2);padding-right:calc({{SIZE}}{{UNIT}}/2)',
				'(desktop+) {{WRAPPER}} .goso-grid > li:not(.grid-2-style):nth-of-type(3n+3)' => 'margin-right : 0',
				'(desktop+) {{WRAPPER}} .goso-grid > li.grid-2-style:nth-of-type(2n+2)'       => 'margin-right : 0',
			),
			'label_block'    => true,
			'condition'      => [
				'goso_style!' => [
		...
		$this->add_responsive_control( 'goso_bitems_martop', array(
		...
		$this->add_responsive_control( 'goso_sitems_martop', array(
		...
		$this->add_control( 'goso_paging', array(
		...
		$this->add_responsive_control( 'goso_paging_martop', array(
		...
		$this->add_control( 'pmeta_color', array(
			...
			'default'   => '',
			'selectors' => array(
				'{{WRAPPER}} .header-standard .author-post span,' . '{{WRAPPER}} .goso-post-box-meta .goso-box-meta span,' . '{{WRAPPER}} .goso-post-box-meta .goso-box-meta a' => 'color: {{VALUE}};',
		...
		$this->add_responsive_control( 'spacing_thumbnail', array(
			'label'     => __( 'Thumbnail Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .standard-post-image, {{WRAPPER}} .goso-grid li .item > .thumbnail, {{WRAPPER}} .goso-masonry .item-masonry > .thumbnai' => 'margin-bottom: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->add_responsive_control( 'spacing_categories', array(
			'label'     => __( 'Categories Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-featured-infor .cat, {{WRAPPER}} .overlay-header-box .cat, {{WRAPPER}} .goso-standard-cat, {{WRAPPER}} .goso-grid li .item .cat, {{WRAPPER}} .goso-masonry .item-masonry .cat' => 'margin-bottom: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->add_responsive_control( 'spacing_title', array(
			'label'     => __( 'Title Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-entry-title' => 'margin-bottom: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->add_responsive_control( 'spacing_meta', array(
			'label'     => __( 'Meta Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
		...
		$this->add_responsive_control( 'meta_group_spacing', array(
			'label'     => __( 'Header Group Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-overlay-over .overlay-header-box, {{WRAPPER}} .grid-header-box' => 'padding-bottom: {{SIZE}}{{UNIT}}',
		...
		$this->add_responsive_control( 'item_content_spacing', array(
			'label'     => __( 'Post Excerpt/Content Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-grid li .item .item-content, {{WRAPPER}} .goso-masonry .item-masonry .item-content, {{WRAPPER}} .goso-grid .mixed-detail .item-content' => 'margin-top: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->add_responsive_control( 'btn_readmore_spacing', array(
			'label'      => __( 'Read More Spacing', 'authow' ),
			'type'       => Controls_Manager::SLIDER,
			'separator'  => 'before',
			'range'      => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors'  => array(
				'{{WRAPPER}} .goso-more-link a.more-link, {{WRAPPER}} .goso-readmore-btn, {{WRAPPER}} .goso-featured-cat-seemore' => 'margin-top: {{SIZE}}{{UNIT}}'
			),
			'conditions' => [
				'relation' => 'OR',
				'terms'    => [
		...
		$this->add_responsive_control( 'item_boxmeta_spacing', array(
			'label'     => __( 'Share Box Spacing', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'separator' => 'before',
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-post-box-meta.goso-post-box-grid, {{WRAPPER}} .goso-post-box-meta' => 'margin-top: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->end_controls_section();
		...
		$this->start_controls_section( 'section_control_bpostspacing', array(
			'label'     => __( 'Elements Spacing for Big Post', 'authow' ),
			'tab'       => Controls_Manager::TAB_CONTENT,
			'condition' => [
				'goso_style' => [
					'mixed',
		...
		$this->add_responsive_control( 'bspacing_thumbnail', array(
			...
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-el-mixed-s1 .standard-post-image' => 'margin-bottom: {{SIZE}}{{UNIT}}',
			)
		) );
		$this->add_responsive_control( 'bspacing_categories', array(
			...
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-el-mixed-s1 .goso-standard-cat'      => 'margin-bottom: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .overlay-header-box .cat' => 'margin-bottom: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->add_responsive_control( 'bspacing_title', array(
			...
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-el-mixed-s1 .standard-pitem .goso-entry-title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .classic-pitem .goso-entry-title'  => 'margin-bottom: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .overlay-layout .goso-entry-title' => 'margin-bottom: {{SIZE}}{{UNIT}}',
			)
		) );
		$this->add_responsive_control( 'bspacing_meta', array(
			...
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-el-mixed-s1 .standard-pitem .header-standard .author-post'         => 'margin-top: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .classic-pitem .header-standard .author-post'          => 'margin-top: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .goso-overlay-over .goso-meta-author.overlay-author' => 'margin-top: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->add_responsive_control( 'bmeta_group_spacing', array(
			...
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-el-mixed-s1 .standard-pitem .header-standard'        => 'padding-bottom: {{SIZE}}{{UNIT}};margin-bottom: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .classic-pitem .header-standard'         => 'padding-bottom: {{SIZE}}{{UNIT}};margin-bottom: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .goso-overlay-over .overlay-header-box' => 'padding-bottom: {{SIZE}}{{UNIT}};margin-bottom: {{SIZE}}{{UNIT}}',
			)
		) );
		...
		$this->add_responsive_control( 'bitem_boxmeta_spacing', array(
			...
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-el-mixed-s1 .standard-pitem .goso-post-box-meta' => 'margin-top: {{SIZE}}{{UNIT}}',
				'{{WRAPPER}} .goso-el-mixed-s1 .classic-pitem .goso-post-box-meta'  => 'margin-top: {{SIZE}}{{UNIT}}'
			)
		) );
		$this->add_responsive_control( 'bitem_btn_readmore_spacing', array(
			...
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 100 ) ),
			'selectors' => array(
				'{{WRAPPER}} .goso-el-mixed-s1 .standard-pitem .goso-more-link a.more-link,{{WRAPPER}} .goso-el-mixed-s1 .classic-pitem .goso-more-link a.more-link' => 'margin-top: {{SIZE}}{{UNIT}}'
			),
		) );
		$this->end_controls_section();
	}
