...
namespace GosoAuthowElementor\Modules\GosoBigGrid\Widgets;
...
use GosoAuthowElementor\Modules\QueryControl\Controls\Goso_Group_Control_Posts;
...
class GosoBigGrid extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'bgquery_type', array(
			'label'   => __( 'Query Type:', 'authow' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'post',
			'options' => array(
				'post'   => esc_html__( 'Based Posts', 'authow' ),
				'custom' => esc_html__( 'Custom', 'authow' ),
			)
		) );

		$this->add_control( 'style', array(
			'label'   => __( 'Big Grid Style', 'authow' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'style-1',
			'options' => array(
				'style-1'  => esc_html__( 'Grid ( Default )', 'authow' ),
				'style-2'  => esc_html__( 'Masonry', 'authow' ),
				...
				'style-8'  => esc_html__( 'Style 8', 'authow' ),
				'style-9'  => esc_html__( 'Style 9', 'authow' ),
				...
				'style-17' => esc_html__( 'Style 17', 'authow' ),
				'style-18' => esc_html__( 'Style 18', 'authow' ),
				'style-19' => esc_html__( 'Style 19', 'authow' ),
				'style-20' => esc_html__( 'Style 20', 'authow' ),
				'style-21' => esc_html__( 'Style 21', 'authow' ),
				'style-22' => esc_html__( 'Style 22', 'authow' ),
			)
		) );

		$this->add_control( 'bg_columns', array(
			'label'     => __( 'Grid/Masonry Style Columns', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => '3',
			'options'   => array(
				...
				'5' => esc_html__( '5 Columns', 'authow' ),
				'6' => esc_html__( '6 Columns', 'authow' )
			),
			'condition' => array( 'style' => array( 'style-1', 'style-2' ) ),
		) );

		$this->add_control( 'bg_columns_tablet', array(
			'label'     => __( 'Grid/Masonry Style Columns on Tablet', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => '',
			'options'   => array(
		...
		$this->add_control( 'bg_columns_mobile', array(
			'label'     => __( 'Grid/Masonry Style Columns on Mobile', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => '1',
			'options'   => array(
				'1' => esc_html__( '1 Column', 'authow' ),
		...
		$this->add_control( 'bg_postmeta', array(
			'label'     => __( 'Showing Post Data', 'authow' ),
			'type'      => Controls_Manager::SELECT2,
			'default'   => array( 'cat', 'title', 'author', 'date' ),
			'multiple'  => true,
			'options'   => array(
				'cat'     => esc_html__( 'Categories', 'authow' ),
				'title'   => esc_html__( 'Title', 'authow' ),
				'author'  => esc_html__( 'Author', 'authow' ),
				'date'    => esc_html__( 'Date', 'authow' ),
				'comment' => esc_html__( 'Comments', 'authow' ),
				'views'   => esc_html__( 'Views', 'authow' ),
				'reading' => esc_html__( 'Reading Time', 'authow' ),
				'excerpt' => esc_html__( 'Post Excerpt', 'authow' ),
			),
		...
		$this->add_control( 'primary_cat', array(
			'label'        => __( 'Show Primary Category Only', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'description'  => __( 'If you using Yoast SEO or Rank Math plugin, this option will show only the primary category from those plugins. If you don\'t use those plugins, it will show the first category in the list categories of the posts.', 'authow' ),
		...
		$this->add_control( 'hide_cat_small', array(
			'label'        => __( 'Hide Post Categories on Small Grid Items', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control( 'hide_meta_small', array(
			'label'        => __( 'Hide Post Meta( Author, Date.. ) on Small Grid Items', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'hide_excerpt_small', array(
			'label'        => __( 'Hide Only Post Excerpt on Small Grid Items', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'hide_subtitle_mobile', array(
			'label'        => __( 'Hide Post Categories/Sub Title on Mobile', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'hide_desc_mobile', array(
			'label'        => __( 'Hide All Post Meta/Description on Mobile', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'hide_excerpt_mobile', array(
			'label'        => __( 'Hide Post Excerpt on Mobile', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'show_readmore', array(
			'label'        => __( 'Show Read More Button', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control( 'hide_rm_small', array(
			'label'        => __( 'Hide Read More Button on Small Grid Items', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'hide_readmore_mobile', array(
			'label'        => __( 'Hide Read More Button on Mobile', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'show_formaticon', array(
			'label'        => __( 'Show Post Format Icons', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'formaticon_pos', array(
			'label'     => __( 'Post Format Icon Position', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'top-right',
			'options'   => array(
				'top-right'    => esc_html__( 'Top Right', 'authow' ),
				'top-left'     => esc_html__( 'Top Left', 'authow' ),
				'bottom-right' => esc_html__( 'Bottom Right', 'authow' ),
				'bottom-left'  => esc_html__( 'Bottom Left', 'authow' ),
		...
		$this->add_control( 'show_reviewpie', array(
			'label'        => __( 'Show Review Scores from Goso Review plugin', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'reviewpie_pos', array(
			'label'     => __( 'Review Scores Position', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'top-left',
			'options'   => array(
				'top-right'    => esc_html__( 'Top Right', 'authow' ),
		...
		$this->add_control( 'onecol_mobile', array(
			'label'        => __( 'Display One Column on Mobile?', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'sameh_mobile', array(
			'label'        => __( 'Display Grid Items Same Height on Mobile?', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'bgcontent_pos', array(
			'label'     => __( 'Big Grid Content Position', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'on',
			'options'   => array(
		...
		$this->add_responsive_control( 'bg_gap', array(
			'label'     => __( 'Gap Between Grid & Mansonry Items', 'authow' ),
		...
		$this->add_responsive_control( 'imgradius', array(
			'label'     => __( 'Custom Border Radius for Images', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control( 'bg_height', array(
			'label'     => __( 'Custom Big Grid Height (Unit is px)', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$this->add_control( 'bg_pagination', array(
			'label'     => esc_html__( 'Page Navigation', 'authow' ),
		...
		$this->add_control( 'paging', array(
			...
			'options'     => array(
				...
				'nextprev' => esc_html__( 'Ajax Next/Previous', 'authow' ),
				'numbers'  => esc_html__( 'Page Navigation Numbers', 'authow' ),
				'loadmore' => esc_html__( 'Load More Posts Button', 'authow' ),
		...
		$this->add_control( 'paging_align', array(
			'label'     => __( 'Page Navigation Align', 'authow' ),
			'type'      => Controls_Manager::SELECT,
		...
		$this->start_controls_section( 'bg_custom', array(
			'label'     => __( 'Custom Grid Items', 'authow' ),
		...
		$repeater->add_control( 'title_link', array(
			'label'       => __( 'Add Link for Title & Image', 'authow' ),
		...
		$repeater->add_control( 'desc', array(
			...
			'default'    => __( 'I am demo text - click edit button to change me.', 'authow' ),
			'show_label' => true,
		) );
		...
		$repeater->add_control( 'item_overlaybg', array(
			'label'     => esc_html__( 'Custom Overlay Background for This Item. It will only affect this item only. To adjust the style for all items, check options on the Style tab at the top.', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
		...
		$repeater->add_control( 'button_border_color', array(
			'label'      => __( 'Button Border Color', 'authow' ),
			'type'       => Controls_Manager::COLOR,
			'selectors'  => array(
		...
		$repeater->add_control( 'button_border_hcolor', array(
			'label'      => __( 'Button Border Hover Color', 'authow' ),
			'type'       => Controls_Manager::COLOR,
			'selectors'  => array(
		...
		$repeater->add_responsive_control( 'bgoverlay_padding', array(
			'label'      => __( 'Content Text Padding', 'authow' ),
		...
		$repeater->add_responsive_control( 'bgoverlay_margin', array(
			'label'      => __( 'Content Text Margin', 'authow' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%', 'em' ),
			'selectors'  => array(
		...
		$this->add_control( 'biggrid_items', array(
			'label'       => __( 'Big Grid Custom Items', 'authow' ),
		...
		$this->start_controls_section( 'biggrid_section_imgsize', array(
			'label' => __( 'Custom Image Sizes', 'authow' ),
		) );
		...
		$this->add_control( 'mthumb_size', array(
			'label'   => __( 'Custom Image Size for Mobile', 'authow' ),
			'type'    => Controls_Manager::SELECT,
			'default' => '',
			'options' => $this->get_list_image_sizes( true ),
		) );
		...
		$this->add_control( 'bg_pos_display', array(
			'label'     => esc_html__( 'Content Text Position and Display', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
		...
		$this->add_control( 'content_vertical_position', array(
			'label'                => __( 'Content Text Vertical Position', 'authow' ),
			'type'                 => Controls_Manager::CHOOSE,
			'label_block'          => false,
			'options'              => array(
				'top'    => array(
		...
		$this->add_control( 'content_display', array(
			'label'   => __( 'Content Text Display', 'authow' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'block',
			'options' => array(
				'block'        => esc_html__( 'Block', 'authow' ),
				'inline-block' => esc_html__( 'Inline Block', 'authow' ),
			),
		) );

		$this->add_responsive_control( 'content_width', array(
			'label'      => __( 'Content Text Max-Width', 'authow' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array( '%', 'px' ),
			'range'      => array(
				'%'  => array( 'min' => 0, 'max' => 100, ),
		...
		$this->add_control( 'bg_padding_margin', array(
			'label'     => esc_html__( 'Content Text Padding and Margin', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
		...
		$this->start_controls_section( 'section_biggrid_overlay', array(
			'label' => __( 'Big Grid Overlay', 'authow' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		) );

		$this->add_control( 'overlay_type', array(
			'label'   => __( 'Apply Overlay On:', 'authow' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'whole',
			'options' => array(
				'whole' => 'Whole Image',
		...
		$this->add_responsive_control( 'overlay_hopacity', array(
			'label'     => __( 'Overlay Hover Opacity(%)', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => array( '%' => array( 'min' => 0, 'max' => 100, 'step' => 1 ) ),
			'selectors' => array(
		...
		$this->add_control( 'apply_spe_bg_subtitle', array(
			'label' => __( 'Apply Separate Background for Categories/Sub Title', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );

		$this->add_control( 'spe_bg_subtitle', array(
			'label'     => __( 'Background for Categories/Sub Title', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'spe_bg_hsubtitle', array(
			'label'     => __( 'Background for Categories/Sub Title on Hover', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'apply_spe_bg_title', array(
			'label' => __( 'Apply Separate Background for Title', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );

		$this->add_control( 'spe_bg_title', array(
			'label'     => __( 'Background for Title', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'spe_bg_htitle', array(
			'label'     => __( 'Background for Title on Hover', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'apply_spe_bg_meta', array(
			'label' => __( 'Apply Separate Background for Post Meta/Description', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );

		$this->add_control( 'spe_bg_meta', array(
			'label'     => __( 'Background for Post Meta/Description', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'spe_bg_hmeta', array(
			'label'     => __( 'Background for Post Meta/Description on Hover', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->start_controls_section( 'section_bg_hover_effect', array(
			'label' => __( 'Hover Effect', 'authow' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		) );

		$this->add_control( 'image_hover', array(
			'label'   => __( 'Image Hover Effect', 'authow' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'zoom-in',
			'options' => array(
				'zoom-in'     => 'Zoom-In',
		...
		$this->add_control( 'text_overlay', array(
			'label'   => __( 'Content Text Hover Type', 'authow' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'none',
			'options' => array(
				'none'    => 'None',
		...
		$this->add_control( 'text_overlay_ani', array(
			'label'     => __( 'Content Text Hover Animation', 'authow' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'movetop',
			'options'   => array(
				'movetop'    => 'Move to Top',
		...
		$this->add_control( 'title_anivisi', array(
			'label'     => __( 'Makes Titles Always Visible?', 'authow' ),
			'type'      => Controls_Manager::SWITCHER,
			'condition' => array( 'text_overlay' => array( 'show-in', 'hide-in' ) ),
		) );
		...
		$this->start_controls_section( 'section_biggrid_typo', array(
			'label' => __( 'Big Grid Typography & Colors', 'authow' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		) );

		$this->add_control( 'bgitem_design', array(
			'label'     => esc_html__( 'Big Grid Items', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );

		$this->add_control( 'ver_border', array(
			'label'        => __( 'Add Vertical Border Between Post Items', 'authow' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'authow' ),
			'label_off'    => __( 'No', 'authow' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'ver_bordercl', array(
			'label'     => __( 'Custom Vertical Border Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_responsive_control( 'ver_borderw', array(
			'label'     => __( 'Custom Vertical Border Width', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors' => array(
		...
		$this->add_control( 'subtitle_design', array(
			'label'     => esc_html__( 'Post Categories/ Sub Title', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
		...
		$this->add_control( 'bgsub_title_hover', array(
			'label'     => __( 'Links Hover Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_group_control( Group_Control_Typography::get_type(), array(
			...
			'label'     => __( 'Title Typography for Big Items', 'authow' ),
		...
		$this->add_control( 'desc_design', array(
			'label'     => esc_html__( 'Post Meta/ Description Text', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
		...
		$this->add_control( 'excerpt_design', array(
			'label'     => esc_html__( 'Post Excerpt', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => array( 'bgquery_type' => 'post' ),
		) );
		...
		$this->add_control( 'readmore_design', array(
			'label'     => esc_html__( 'Read More Button', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
		...
		$this->add_control( 'add_icon_readmore', array(
			'label' => __( 'Add Icon to "Read More" Button', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );
		...
		$this->add_responsive_control( 'pagi_mwidth', array(
			'label'      => __( 'Load More Posts Button Max Width', 'authow' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array( '%', 'px' ),
			'range'      => array(
				'%'  => array( 'min' => 0, 'max' => 100, ),
		...
		$this->add_control( 'pagi_hcolor', array(
			'label'     => __( 'Text Hover & Active Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'bgpagi_hcolor', array(
			'label'     => __( 'Borders Hover & Active Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
	...
	protected function register_query_section_controls() {
		...
		$this->start_controls_section( 'section_query', array(
			'label'     => __( 'Query Based Posts', 'authow' ),
			'condition' => array( 'bgquery_type' => 'post' ),
			'tab'       => Controls_Manager::TAB_CONTENT
		) );

		$this->add_group_control( Goso_Group_Control_Posts::get_type(), array(
			'name' => 'posts'
		) );
		...
		$this->add_control( 'arposts_per_page', array(
			'label'       => __( 'Posts Per Page', 'authow' ),
			'description' => __( 'This option only work for Archive Builder', 'authow' ),
			'type'        => Controls_Manager::NUMBER,
			'default'     => 10,
		...
		$this->add_control( 'arposts_new', array(
			'label'       => __( 'Always Show Newest Posts', 'authow' ),
			'description' => __( 'This option will sticky newest posts when your page go to a new pagination', 'authow' ),
			'type'        => Controls_Manager::SWITCHER,
			'condition'   => array( 'posts_post_type' => array( 'current_query' ) ),
		) );
		...
		$this->add_control( 'offset', array(
			'label'       => __( 'Offset', 'authow' ),
			'type'        => Controls_Manager::NUMBER,
			'default'     => 0,
			'condition'   => array( 'posts_post_type!' => array( 'by_id' ) ),
			'description' => __( 'Use this setting to skip over posts (e.g. \'2\' to skip over 2 posts).', 'authow' ),
		) );

		$this->add_control( 'avoid_duplicates', [
			'label'       => esc_html__( 'Avoid Duplicates', 'authow' ),
			'type'        => Controls_Manager::SWITCHER,
			'default'     => '',
			'description' => esc_html__( 'Set to Yes to avoid duplicate posts from showing up. This only effects the frontend.', 'authow' ),
			'condition'   => [
				'posts_post_type!' => [
					'by_id',
					'current_query',
