...
namespace GosoAuthowElementor\Modules\GosoFullwidthHeroOverlay\Widgets;
...
class GosoFullwidthHeroOverlay extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'container_width',
			[
				'label'      => __( 'Container Width', 'authow' ),
		...
		$this->add_control(
			'column',
			array(
				'label'   => __( 'Small Posts Columns', 'authow' ),
		...
		$this->add_control(
			'tab_column',
			array(
				'label'   => __( 'Small Posts Columns on Tablet', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					''  => 'Default',
					'2' => '2',
		...
		$this->add_control(
			'mb_column',
			array(
				'label'   => __( 'Small Posts Columns on Mobile', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					''  => 'Default',
					'1' => '1',
		...
		$this->add_control(
			'main_thumb_size', array(
				'label'   => __( 'Image Size for Big Post', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
		...
		$this->add_control(
			'main_mthumb_size', array(
				'label'   => __( 'Image Size for Big Post on Mobile', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => $this->get_list_image_sizes( true ),
			)
		...
		$this->add_responsive_control(
			'img_ratio', array(
				'label'     => __( 'Image Ratio for Small Posts', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_control(
			'thumb_size', array(
				'label'   => __( 'Image Size for Small Posts', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => $this->get_list_image_sizes( true ),
			)
		...
		$this->add_control(
			'mthumb_size', array(
				'label'   => __( 'Image Size for Small Posts on Mobile', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => $this->get_list_image_sizes( true ),
			)
		...
		$this->start_controls_section(
			'section_postmeta', array(
				'label' => esc_html__( 'Post Meta Data', 'authow' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			)
		);
		...
		$this->add_control(
			'post_meta', array(
				'label'    => __( 'Showing Post Meta', 'authow' ),
		...
		$this->add_control(
			'title_blength', array(
				'label'   => __( 'Custom Title Words Length for Big Post', 'authow' ),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 100,
				'step'    => 1,
		...
		$this->add_control(
			'show_bicon', array(
				'label'        => __( 'Hide Post Format Icon on Big Post?', 'authow' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'authow' ),
				'label_off'    => __( 'No', 'authow' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_formaticon', array(
				'label'        => __( 'Show Post Format Icons on Small Posts?', 'authow' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'authow' ),
				'label_off'    => __( 'No', 'authow' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'heading_show_mobile',
			array(
				'label'     => __( 'Showing on Mobile', 'authow' ),
		...
		$this->add_control(
			'hide_cat_mobile', array(
				'label'        => __( 'Hide Post Categories on Mobile?', 'authow' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => '',
			)
		...
		$this->add_control(
			'hide_meta_mobile', array(
				'label'        => __( 'Hide Post Meta on Mobile', 'authow' ),
				'description'  => __( 'Include: Author Name, Date, Comments Count, Views Count, Reading Time', 'authow' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => '',
			)
		...
		$this->add_control(
			'shownav', array(
				'label' => __( 'Hide next/prev buttons', 'authow' ),
				'type'  => Controls_Manager::SWITCHER,
			)
		);
		$this->add_control(
		...
		$this->add_control(
			'item_bg_hover',
			array(
				'label'     => __( 'Overlay Background Color on Hover', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
		...
		$this->add_responsive_control(
			'item_padding', array(
				'label'      => __( 'Element Padding', 'authow' ),
		...
		$this->add_responsive_control(
			'mp_item_padding', array(
				'label'      => __( 'Big Post Padding', 'authow' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			'mp_icon_iw', array(
				'label'     => __( 'Icon/Content Width ( % )', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'mp_icon_content_spacing', array(
				'label'     => __( 'Spacing Between Icon & Content', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'mp_lp_spacing', array(
				'label'     => __( 'Spacing Between Big Post & Small Posts', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'mp_icon_size', array(
				'label'     => __( 'Icon Wrapper Size', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_control(
			'heading_pcat',
			array(
				'label'     => __( 'Big Post Categories', 'authow' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'heading_ptitle',
			array(
				'label'     => __( 'Big Post Title', 'authow' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Small List Posts', 'authow' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_responsive_control(
			'small_post_item_bg',
			array(
				'label'     => __( 'Post Content Background Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
		...
		$this->add_responsive_control(
			'small_post_item_padding', array(
				'label'      => __( 'Post Content Padding', 'authow' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => __( 'Post Categories', 'authow' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Post Icon Format', 'authow' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
		...
		$this->add_responsive_control(
			'small_post_post_spacing', array(
				'label'     => __( 'Horizontal Spacing Between each Posts', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'small_post_post_vspacing', array(
				'description' => __( 'This option does not apply when small posts showing as slider', 'authow' ),
				'label'     => __( 'Vertical Spacing Between each Posts', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
				'selectors' => array(
		...
		$this->add_responsive_control(
			'small_post_thumbnail_space', array(
				'label'     => __( 'Post Thumbnail Margin Bottom', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
				'selectors' => array(
		...
		$this->add_responsive_control(
			'small_post_meta_space', array(
				'label'     => __( 'Post Meta Margin Top', 'authow' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
				'selectors' => array(
