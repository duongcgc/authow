...
namespace GosoAuthowElementor\Modules\GosoButtonPopup\Widgets;
...
class GosoButtonPopup extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'text', array(
				...
				'placeholder' => __( 'Add Button Text Here', 'authow' ),
			) );
		...
		$this->add_control( 'add_borders', array(
				'label'     => __( 'Add Borders to Button', 'authow' ),
		...
		$this->add_responsive_control( 'border_width', array(
				'label'      => __( 'Custom Button Borders Width', 'authow' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_control( 'add_subtext', array(
				'label'     => __( 'Add Subtext?', 'authow' ),
				'type'      => Controls_Manager::SWITCHER,
				'separator' => 'before',
			) );
		$this->add_control( 'subtext', array(
				'label'       => __( 'SubText', 'authow' ),
				'type'        => Controls_Manager::TEXTAREA,
				'default'     => __( 'Example Subtext', 'authow' ),
				'placeholder' => __( 'Add Your SubText Here', 'authow' ),
				'label_block' => true,
		...
		$this->add_responsive_control( 'subtext_margin', array(
				'label'      => __( 'Subtext Margin', 'authow' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', 'em', '%' ),
				'default'    => array(
					'top'      => '',
		...
		$this->add_control( 'button_id', array(
				'label'       => __( 'Button ID', 'authow' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'title'       => __( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'authow' ),
				'description' => __( 'Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'authow' ),
				'separator'   => 'before',
			) );
		...
		$this->start_controls_section( 'section_popup_content', array(
			'label' => esc_html__( 'Popup Content', 'authow' ),
			'tab'   => Controls_Manager::TAB_CONTENT,
		) );

		$this->add_control( 'popup_cstyle', array(
				'label'   => __( 'Popup Content Style:', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'text',
				'options' => [
		...
		$this->add_control( 'popup_anityle', array(
				'label'   => __( 'Popup Open Animation Style:', 'authow' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'move-to-top',
				'options' => [
		...
		$this->add_group_control( Group_Control_Typography::get_type(), array(
				'name'      => 'subtext_typo',
				'label'     => __( 'SubText Typography', 'authow' ),
		...
		$this->add_group_control( Group_Control_Background::get_type(), array(
				'name'        => 'btbg',
				'label'       => __( 'Button Background', 'authow' ),
		...
		$this->add_control( 'sborder_cl', array(
				'label'     => __( 'Second Borders Color( Gradient Borders )', 'authow' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control( 'subhcolor', array(
				'label'     => __( 'Subtext Hover Color', 'authow' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_group_control( Group_Control_Background::get_type(), array(
				'name'        => 'bthbg',
				'label'       => __( 'Button Hover Background', 'authow' ),
				'types'       => array( 'classic', 'gradient' ),
		...
		$this->add_control( 'sborder_hcl', array(
				'label'     => __( 'Second Borders Hover Color( Gradient Borders )', 'authow' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control( 'hover_animation', array(
				'label' => esc_html__( 'Hover Animation', 'authow' ),
				'type'  => Controls_Manager::HOVER_ANIMATION,
			) );

		$this->add_group_control( Group_Control_Box_Shadow::get_type(), array(
				'name'      => 'hbox_shadow',
				'label'     => __( 'Box Shadow on Hover', 'authow' ),
		...
		$this->start_controls_section( 'section_design_popup', array(
				'label' => __( 'Popup Design', 'authow' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			) );

		$this->add_control( 'btn_popup_de', array(
				'label'      => __( 'Popup Content Padding', 'authow' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
