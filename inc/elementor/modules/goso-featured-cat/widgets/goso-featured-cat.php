...
namespace GosoAuthowElementor\Modules\GosoFeaturedCat\Widgets;
...
class GosoFeaturedCat extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control( 'horizontal_spacing', array(
			'label'          => __( 'Horizontal Spacing Between Post Items', 'authow' ),
			'type'           => Controls_Manager::SLIDER,
			'default'        => array( 'size' => '' ),
			'mobile_default' => [
				'size' => 0
			...
			'range'          => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors'      => array(
				'(tablet+){{WRAPPER}} .home-featured-cat-content:not(.style-6) .cat-left'                                                                                             => 'padding-right: calc({{SIZE}}{{UNIT}} / 2)',
				'(tablet+){{WRAPPER}} .home-featured-cat-content:not(.style-6) .cat-right'                                                                                            => 'padding-left: calc({{SIZE}}{{UNIT}} / 2)',
		...
		$this->add_responsive_control( 'simgwidth', array(
			'label'     => __( 'Custom Image Width for Small Posts', 'authow' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$this->add_control( 'big_title_length', array(
			'label'       => __( 'Custom Words Length for Post Titles for Big Posts', 'authow' ),
		...
		$this->add_control( 'cat_seemore', array(
			'label'     => __( 'Enable "View All" Button', 'authow' ),
			'type'      => Controls_Manager::SWITCHER,
			'separator' => 'before',
		) );
		$this->add_control( 'cat_view_link', array(
			'label'       => __( 'Custom Link for "View All" Button', 'authow' ),
		...
		$this->add_control( 'cat_remove_arrow', array(
			'label'     => __( 'Remove arrow on "View All"', 'authow' ),
			'type'      => Controls_Manager::SWITCHER,
			'condition' => array( 'cat_seemore' => 'yes' ),
		) );
		$this->add_control( 'cat_readmore_button', array(
			'label'     => __( 'Make "View All" is A Button', 'authow' ),
			'type'      => Controls_Manager::SWITCHER,
			'condition' => array( 'cat_seemore' => 'yes' ),
		) );
		$this->add_control( 'cat_readmore_align', array(
			'label'       => __( 'Align "View All" Button', 'authow' ),
		...
		$this->add_responsive_control( 'cat_readmore_martop', array(
			'label'       => __( 'Custom Margin Top for "View All" Button', 'authow' ),
			'type'        => Controls_Manager::SLIDER,
			'default'     => array( 'size' => '' ),
			'range'       => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors'   => array(
		...
		$this->add_responsive_control( 'spacing_content', array(
			'label'       => __( 'Content/Excerpt Spacing', 'authow' ),
			'type'        => Controls_Manager::SLIDER,
			'default'     => array( 'size' => '' ),
			'range'       => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors'   => array(
		...
		$this->add_responsive_control( 'bspacing_heading_text', array(
			'label'     => __( 'Spacing for Big Post', 'authow' ),
		...
		$this->add_responsive_control( 'bspacing_btom', array(
			'label'       => __( 'Big Post Spacing to Bottom', 'authow' ),
			'type'        => Controls_Manager::SLIDER,
			'default'     => array( 'size' => '' ),
			'range'       => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors'   => array(
		...
		$this->add_responsive_control( 'bspacing_hgroup', array(
			'label'       => __( 'Header Group Spacing Top', 'authow' ),
			'type'        => Controls_Manager::SLIDER,
			'default'     => array( 'size' => '' ),
			'range'       => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors'   => array(
		...
		$this->add_responsive_control( 'bspacing_hgroup_b', array(
			'label'       => __( 'Header Group Spacing Bottom', 'authow' ),
			'type'        => Controls_Manager::SLIDER,
			'default'     => array( 'size' => '' ),
			'range'       => array( 'px' => array( 'min' => 0, 'max' => 200, ) ),
			'selectors'   => array(
		...
		$this->add_responsive_control( 'padding_around', array(
			'label'      => __( 'Add Padding Around Post Items', 'authow' ),
		...
		$this->add_responsive_control( 'borders_around', array(
			'label'      => __( 'Borders Width Around Post Items', 'authow' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => array( 'px', '%', 'em' ),
			'selectors'  => array(
		...
		$this->add_control( 'pbg_around', array(
			'label'     => __( 'Add Background Color for Post Items?', 'authow' ),
			'type'      => Controls_Manager::COLOR,
		...
		$this->add_control( 'heading_pexcrept_settings', array(
			'label'     => __( 'Posts Excerpt', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
		$this->add_control( 'pexcerpt_color', array(
			'label'     => __( 'Post Excerpt Color', 'authow' ),
			'type'      => Controls_Manager::COLOR,
		...
		$this->add_control( 'heading_pbutton_settings', array(
			'label'     => __( 'View all" Button', 'authow' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		) );
	...
	protected function render() {
		...
		echo \Authow_VC_Shortcodes::featured_cat( array(
