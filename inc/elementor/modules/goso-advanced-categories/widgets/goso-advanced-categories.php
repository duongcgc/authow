...
namespace GosoAuthowElementor\Modules\GosoAdvancedCategories\Widgets;
...
class GosoAdvancedCategories extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->add_control( 'hide_empty', array(
			'label' => __( 'Show Empty Categories?', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );

		$this->add_control( 'hierarchical', array(
			'label' => __( 'Show in hierarchical?', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );
		...
		$this->add_control( 'mark_count', array(
			'label' => __( 'Highlight posts count?', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		) );

		$this->add_control( 'maxitems', array(
			'label'   => __( 'Limit Category to Show', 'authow' ),
			'type'    => Controls_Manager::NUMBER,
			'default' => 10,
		) );

		$this->add_control( 'excluded', array(
			'label'       => __( 'Exclude Term IDs:', 'authow' ),
			'description' => __( 'E.g:  1, 2, 4', 'authow' ),
		...
		$this->add_group_control( Group_Control_Typography::get_type(), array(
			'name'     => 'term_name_typo',
			'label'    => __( 'Term Name Typography', 'authow' ),
		...
		$this->add_control( 'term_name_mcolor', array(
			'type'      => Controls_Manager::COLOR,
			'label'     => __( 'Post Count Color', 'authow' ),
			'condition' => [
				'style!' => 'style-3',
				'count'  => 'yes'
			],
		...
		$this->add_control( 'term_name_mhcolor', array(
			'type'      => Controls_Manager::COLOR,
			'label'     => __( 'Post Count Hover Color', 'authow' ),
		...
		$this->add_control( 'term_name_nbgcolor', array(
			'type'      => Controls_Manager::COLOR,
			'label'     => __( 'Post Count BackgroundColor', 'authow' ),
			'condition' => [
				'style'      => 'style-1',
				'mark_count' => 'yes',
				'count'      => 'yes',
		...
		$this->add_control( 'term_name_nbghcolor', array(
			'type'      => Controls_Manager::COLOR,
			'label'     => __( 'Post Count Hover Background Color', 'authow' ),
			'condition' => [
				'style'      => 'style-1',
				'mark_count' => 'yes',
				'count'      => 'yes',
		...
		$this->add_control( 'term_name_bdhcolor', array(
			'type'      => Controls_Manager::COLOR,
			'label'     => __( 'Border Hover Color', 'authow' ),
		...
		$this->add_control( 'term_name_padding', array(
			...
			'label'      => __( 'Term Name Padding', 'authow' ),
			'size_units' => array( 'px' ),
			'condition'  => [ 'style' => 'style-2' ],
			'selectors'  => array(
