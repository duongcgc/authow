 ...
 * Widget products.
 */
if ( ! class_exists( 'Goso_Product_Lists' ) ) {
	class Goso_Product_Lists extends WP_Widget {
		private $widget_id;
		...
		function authow_widget_defaults() {
			return [
				'title'       => 'Goso Products List',
				'cats_id'     => '',
				'tags_id'     => '',
				'orderby'     => 'date',
				'order'       => 'desc',
		...
		function form( $instance ) {
            ...
            <!-- Show -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'show' ) ); ?>"><?php esc_html_e( 'Show:', 'authow' ); ?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'show' ) ); ?>"
                    ...
                    <option value='' <?php if ( '' == $instance['show'] ) {
						echo 'selected="selected"';
					} ?>><?php esc_html_e( 'All products', 'authow' ); ?></option>
                    <option value='featured' <?php if ( 'featured' == $instance['show'] ) {
						echo 'selected="selected"';
					} ?>><?php esc_html_e( 'Featured products', 'authow' ); ?></option>
                    <option value='onsale' <?php if ( 'onsale' == $instance['show'] ) {
						echo 'selected="selected"';
					} ?>><?php esc_html_e( 'On-sale products', 'authow' ); ?></option>
                </select>
            </p>
            ...
            <p>
                ...
                <select id="<?php echo esc_attr( $this->get_field_id( 'orderby' ) ); ?>"
                    ...
                    <option value='price' <?php if ( 'price' == $instance['orderby'] ) {
						echo 'selected="selected"';
					} ?>><?php esc_html_e( 'Price', 'authow' ); ?></option>
                    ...
                    <option value='sales' <?php if ( 'sales' == $instance['orderby'] ) {
						echo 'selected="selected"';
					} ?>><?php esc_html_e( 'Sales', 'authow' ); ?></option>
                </select>
            </p>
            ...
            <!-- Products Misc -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'hide_free' ) ); ?>"><?php esc_html_e( 'Hide Free Products?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'show_hidden' ) ); ?>"><?php esc_html_e( 'Show Hidden Products?:', 'authow' ); ?></label>
	...
	add_action( 'widgets_init', function () {
		register_widget( 'Goso_Product_Lists' );
	} );
}
