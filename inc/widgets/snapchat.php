...
if ( ! class_exists( 'goso_snapchat_widget' ) ) {
	class goso_snapchat_widget extends WP_Widget {
		...
		public function authow_widget_defaults() {
			return array(
				'title'       => esc_html__( 'Follow Me', 'authow' ),
				'username'    => '',
				'userid'      => '',
				'avatar'      => '',
				'avatar_size' => '',
		...
		function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Account Name', 'authow' ) ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'userid' ) ); ?>"><?php esc_html_e( 'ID', 'authow' ) ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'avatar' ) ); ?>"><?php esc_html_e( 'Avatar Image URL', 'authow' ) ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'avatar_size' ) ); ?>"><?php esc_html_e( 'Avatar size (px)', 'authow' ) ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>"><?php esc_html_e( 'Style', 'authow' ) ?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>"
                        name="<?php echo esc_attr( $this->get_field_name( 'style' ) ); ?>" class="widefat">
                    <option value="rounded" <?php selected( $instance['style'], 'rounded' ); ?>><?php esc_html_e( 'Rounded', 'authow' ) ?></option>
                    <option value="circle" <?php selected( $instance['style'], 'circle' ); ?>><?php esc_html_e( 'Circle', 'authow' ) ?></option>
                </select>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'bgstyle' ) ); ?>"><?php esc_html_e( 'Background Style', 'authow' ) ?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'bgstyle' ) ); ?>"
                        name="<?php echo esc_attr( $this->get_field_name( 'bgstyle' ) ); ?>" class="widefat">
                    <option value="flat" <?php selected( $instance['bgstyle'], 'flat' ); ?>><?php esc_html_e( 'Flat', 'authow' ) ?></option>
                    <option value="dots" <?php selected( $instance['bgstyle'], 'dots' ); ?>><?php esc_html_e( 'Dots', 'authow' ) ?></option>
                </select>
            </p>
