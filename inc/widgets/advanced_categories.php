...
if ( ! class_exists( 'penci_advanced_categories_widget' ) ) {
	class penci_advanced_categories_widget extends WP_Widget {
		...
		public function authow_widget_defaults() {
			return array(
				'title'        => esc_html__( 'Categories', 'authow' ),
				'style'        => '',
				'tax'          => 'category',
				'order'        => '',
				'orderby'      => '',
		...
		function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'tax' ) ); ?>"><?php esc_html_e( 'Select Taxnonomy:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'order' ) ); ?>"><?php esc_html_e( 'Order:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'hide_empty' ) ); ?>"><?php esc_html_e( 'Show empty term?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'hierarchical' ) ); ?>"><?php esc_html_e( 'Show in hierarchical?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_html_e( 'Show posts count?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'mark_count' ) ); ?>"><?php esc_html_e( 'Highlight posts count?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'exclude' ) ); ?>"><?php esc_html_e( 'Exclude Term IDs:', 'authow' ); ?></label>
