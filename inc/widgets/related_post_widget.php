...
if ( ! class_exists( 'penci_related_news_widget' ) ) {
	class penci_related_news_widget extends WP_Widget {
		...
		public function authow_widget_defaults() {
			$defaults = array( 'title'        => esc_html__( 'Related Posts', 'authow' ),
			                   'ptfsfe'       => '',
			                   'ptfs'         => '',
			                   'pmfs'         => '',
			                   'image_type'   => 'default',
		...
		function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php esc_html_e( 'Display Related Posts By:', 'authow' ); ?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"
					...
					} ?>><?php esc_html_e( 'Categories', 'authow' ); ?></option>
                    <option value='tags' <?php if ( 'tags' == $instance['type'] ) {
						echo 'selected="selected"';
					} ?>><?php esc_html_e( 'Tags', 'authow' ); ?></option>
                    <option value='primary_cat' <?php if ( 'primary_cat' == $instance['type'] ) {
						echo 'selected="selected"';
					} ?>><?php esc_html_e( 'Primary Category from Yoast SEO Plugin', 'authow' ); ?></option>
                </select>
            </p>
