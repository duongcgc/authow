...
if ( ! class_exists( 'Goso_Widget_Price_Filter' ) ) {
	class Goso_Widget_Price_Filter extends WPH_Widget {
		...
		function __construct() {
			...
			$args['fields'] = array(
				array(
					'id'   => 'title',
					'type' => 'text',
					'std'  => esc_html__( 'Price filter', 'authow' ),
					'name' => esc_html__( 'Title', 'authow' )
				),
				array(
					'id'          => 'show_ranges',
					'type'        => 'checkbox',
					'name'        => esc_html__( 'Show empty price ranges', 'authow' ),
					'description' => esc_html__( 'May increase this widget performance if you have a lot of products in your store.', 'authow' ),
				),
			);
	...
	add_action( 'widgets_init', function () {
		register_widget( 'Goso_Widget_Price_Filter' );
	} );
}
