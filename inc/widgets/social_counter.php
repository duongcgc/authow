...
class Authow_Social_Counter extends WP_Widget {
	...
	public function form( $instance ) {
		$title                  = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Social Counter', 'authow' );
                ...
                <div id="pc_general_social" class="penci-social-tab tab-active">
                    ...
                    <p class="widget-title-settings">
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>"
                            ...
                            <option value="s1" <?php selected( $style, 's1' ); ?>><?php echo esc_html__( 'Style 1', 'authow' ); ?></option>
                            <option value="s2" <?php selected( $style, 's2' ); ?>><?php echo esc_html__( 'Style 2', 'authow' ); ?></option>
                            <option value="s3" <?php selected( $style, 's3' ); ?>><?php echo esc_html__( 'Style 3', 'authow' ); ?></option>
                            <option value="s4" <?php selected( $style, 's4' ); ?>><?php echo esc_html__( 'Style 4', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'fill' ) ); ?>"
                            ...
                            <option value="fill" <?php selected( $fill, 'fill' ); ?>><?php echo esc_html__( 'Filled', 'authow' ); ?></option>
                            <option value="border" <?php selected( $fill, 'border' ); ?>><?php echo esc_html__( 'Bordered', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'shape' ) ); ?>"
                            ...
                            <option value="rectangle" <?php selected( $shape, 'rectangle' ); ?>><?php echo esc_html__( 'Rectangle', 'authow' ); ?></option>
                            <option value="round" <?php selected( $shape, 'round' ); ?>><?php echo esc_html__( 'Round', 'authow' ); ?></option>
                            <option value="circle" <?php selected( $shape, 'circle' ); ?>><?php echo esc_html__( 'Circle', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'color_style' ) ); ?>"
                            ...
                            <option value="custom" <?php selected( $color_style, 'custom' ); ?>><?php echo esc_html__( 'Custom Color', 'authow' ); ?></option>
                            <option value="brandbg" <?php selected( $color_style, 'brandbg' ); ?>><?php echo esc_html__( 'Brand Background', 'authow' ); ?></option>
                            <option value="brandtext" <?php selected( $color_style, 'brandtext' ); ?>><?php echo esc_html__( 'Brand Text', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'columns' ) ); ?>"
                            ...
                            <option value="1" <?php selected( $columns, '1' ); ?>><?php echo esc_html__( '1 Column', 'authow' ); ?></option>
                            <option value="2" <?php selected( $columns, '2' ); ?>><?php echo esc_html__( '2 Columns', 'authow' ); ?></option>
                            <option value="3" <?php selected( $columns, '3' ); ?>><?php echo esc_html__( '3 Columns', 'authow' ); ?></option>
                            <option value="4" <?php selected( $columns, '4' ); ?>><?php echo esc_html__( '4 Columns', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'tab_column' ) ); ?>"
                            ...
                            <option value="" <?php selected( $tab_column, '' ); ?>><?php echo esc_html__( 'Default', 'authow' ); ?></option>
                            <option value="1" <?php selected( $tab_column, '1' ); ?>><?php echo esc_html__( '1 Column', 'authow' ); ?></option>
                            <option value="2" <?php selected( $tab_column, '2' ); ?>><?php echo esc_html__( '2 Columns', 'authow' ); ?></option>
                            <option value="3" <?php selected( $tab_column, '3' ); ?>><?php echo esc_html__( '3 Columns', 'authow' ); ?></option>
                            <option value="4" <?php selected( $tab_column, '4' ); ?>><?php echo esc_html__( '4 Columns', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'mobile_column' ) ); ?>"
                            ...
                            <option value="" <?php selected( $mobile_column, '' ); ?>><?php echo esc_html__( 'Default', 'authow' ); ?></option>
                            <option value="1" <?php selected( $mobile_column, '1' ); ?>><?php echo esc_html__( '1 Column', 'authow' ); ?></option>
                            <option value="2" <?php selected( $mobile_column, '2' ); ?>><?php echo esc_html__( '2 Columns', 'authow' ); ?></option>
                            <option value="3" <?php selected( $mobile_column, '3' ); ?>><?php echo esc_html__( '3 Columns', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'use_shadow' ) ); ?>"
                            ...
                            <option value="no" <?php selected( $use_shadow, 'no' ); ?>><?php echo esc_html__( 'No', 'authow' ); ?></option>
                            <option value="yes" <?php selected( $use_shadow, 'yes' ); ?>><?php echo esc_html__( 'Yes', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
                        ...
                        <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'hide_count' ) ); ?>"
                            ...
                            <option value="no" <?php selected( $hide_count, 'no' ); ?>><?php echo esc_html__( 'No', 'authow' ); ?></option>
                            <option value="yes" <?php selected( $hide_count, 'yes' ); ?>><?php echo esc_html__( 'Yes', 'authow' ); ?></option>
                        </select>
                    </p>
                    <p>
