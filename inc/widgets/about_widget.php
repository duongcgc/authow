...
if ( ! class_exists( 'penci_about_widget' ) ) {
	class penci_about_widget extends WP_Widget {
		...
		function form( $instance ) {
            ...
            <!-- image url -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php esc_html_e( 'About Image URL:', 'authow' ); ?></label>
                ...
                <small><?php _e( 'Insert your image URL. To get good for load, let use image about 400px width.<br>You can check <a href="https://www.wpbeginner.com/beginners-guide/how-to-get-the-url-of-images-you-upload-in-wordpress/" target="_blank" rel="noreferrer noopener">this guide</a> to know how to get URL of an image you upload.', 'authow' ); ?></small>
            </p>

            <!-- Circle image -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'circle' ) ); ?>"><?php esc_html_e( 'Make About Image Circle:', 'authow' ); ?></label>
                ...
                <small><?php esc_html_e( 'To use this feature, please use square image for your image above to get best display.', 'authow' ); ?></small>
            </p>

            <!-- Lazyload image -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'lazyload' ) ); ?>"><?php esc_html_e( 'Disable Lazyload for About Me Image:', 'authow' ); ?></label>
            ...
            <!-- Link for image -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'imageurl' ) ); ?>"><?php esc_html_e( 'Add Link for About Image:', 'authow' ); ?></label>
            ...
            <!-- Open new tab image -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>"><?php esc_html_e( 'Click About Image Open in New Tab?', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'imagemaxwidth' ) ); ?>"><?php esc_html_e( 'Custom Max Width for About Me Image:', 'authow' ); ?></label>
            ...
            <!-- heading text -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'heading' ) ); ?>"><?php esc_html_e( 'Heading Text:', 'authow' ); ?></label>
            ...
            <!-- description -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>"><?php esc_html_e( 'About me text: ( you can use HTML here )', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'fheading' ) ); ?>"><?php esc_html_e( 'Heading Text Font Size ( Default: 18 )', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'fdesc' ) ); ?>"><?php esc_html_e( 'About Me Text Font Size', 'authow' ); ?></label>
