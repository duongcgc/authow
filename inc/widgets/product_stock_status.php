<?php
if ( ! class_exists( 'Goso_Stock_Status' ) ) {
	class Goso_Stock_Status extends WPH_Widget {
		function __construct() {
			...
			$args['fields'] = array(
				array(
					'id'      => 'title',
					'type'    => 'text',
					'default' => esc_html__( 'Stock status', 'authow' ),
				...
				array(
					...
					'type'    => 'checkbox',
					'default' => 1,
					'name'    => esc_html__( 'On Sale filter', 'authow' ),
				),
				...
				array(
					...
					'type'    => 'checkbox',
					'default' => 1,
					'name'    => esc_html__( 'In Stock filter', 'authow' ),
				),
			);
	...
	add_action( 'widgets_init', function () {
		register_widget( 'Goso_Stock_Status' );
	} );
}
