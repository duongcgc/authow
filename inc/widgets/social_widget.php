	...
	class penci_social_widget extends WP_Widget {
		...
		function form( $instance ) {
            ...
            <p>
                ...
                <small><?php esc_html_e( 'This option only apply when you hide text on the right side of social icons.', 'authow' ); ?></small>
            </p>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Display Social Text on Right Icons?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'circle' ) ); ?>"><?php esc_html_e( 'Remove Border Around Icons?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'border_radius' ) ); ?>"><?php esc_html_e( 'Remove Border Radius on Border of Icons?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'brand_color' ) ); ?>"><?php esc_html_e( 'Use Brand Colors for Social Icons?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'size_icon' ) ); ?>"><?php esc_html_e( 'Custom Font Size for Icons:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'size_upper' ) ); ?>"><?php esc_html_e( 'Disable Uppercase Text on Right Icons?:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'size_text' ) ); ?>"><?php esc_html_e( 'Custom Font Size for Text on Right Icons:', 'authow' ); ?></label>
                <input type="number" style="width: 50px;"
            ...
            <p class="description"
               style="padding: 0;"><?php _e( '<strong>Note:</strong> Setup your social URLs via <strong>Appearance > Customize > Social Media</strong>', 'authow' ); ?></p>
            ...
            <div class="social-flex">
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Show Facebook:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Show Twitter:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Show Instagram:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>"><?php esc_html_e( 'Show Pinterest:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Show Likedin:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Show Behance:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'flickr' ) ); ?>"><?php esc_html_e( 'Show Flickr:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'tumblr' ) ); ?>"><?php esc_html_e( 'Show Tumblr:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>"><?php esc_html_e( 'Show Youtube:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Show Email:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'vk' ) ); ?>"><?php esc_html_e( 'Show Vk:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'bloglovin' ) ); ?>"><?php esc_html_e( 'Show Bloglovin:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'vine' ) ); ?>"><?php esc_html_e( 'Show Vine:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud' ) ); ?>"><?php esc_html_e( 'Show Soundcloud:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'snapchat' ) ); ?>"><?php esc_html_e( 'Show Snapchat:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'spotify' ) ); ?>"><?php esc_html_e( 'Show Spotify:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'github' ) ); ?>"><?php esc_html_e( 'Show Github:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'stack-overflow' ) ); ?>"><?php esc_html_e( 'Show Stack Overflow:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'twitch' ) ); ?>"><?php esc_html_e( 'Show Twitch:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'vimeo' ) ); ?>"><?php esc_html_e( 'Show Vimeo:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'steam' ) ); ?>"><?php esc_html_e( 'Show Steam:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'xing' ) ); ?>"><?php esc_html_e( 'Show Xing:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'whatsapp' ) ); ?>"><?php esc_html_e( 'Show Whatsapp:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'telegram' ) ); ?>"><?php esc_html_e( 'Show Telegram:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'reddit' ) ); ?>"><?php esc_html_e( 'Show Reddit:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'ok' ) ); ?>"><?php esc_html_e( 'Show Ok:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( '500px' ) ); ?>"><?php esc_html_e( 'Show 500px:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'stumbleupon' ) ); ?>"><?php esc_html_e( 'Show StumbleUpon:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'wechat' ) ); ?>"><?php esc_html_e( 'Show Wechat:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'weibo' ) ); ?>"><?php esc_html_e( 'Show Weibo:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'line' ) ); ?>"><?php esc_html_e( 'Show LINE:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'viber' ) ); ?>"><?php esc_html_e( 'Show Viber:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'discord' ) ); ?>"><?php esc_html_e( 'Show Discord:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'rss' ) ); ?>"><?php esc_html_e( 'Show RSS:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'slack' ) ); ?>"><?php esc_html_e( 'Show slack:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'mixcloud' ) ); ?>"><?php esc_html_e( 'Show Mixcloud:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'goodreads' ) ); ?>"><?php esc_html_e( 'Show Goodreads:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'tripadvisor' ) ); ?>"><?php esc_html_e( 'Show Tripadvisor:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'tiktok' ) ); ?>"><?php esc_html_e( 'Show Tiktok:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'dailymotion' ) ); ?>"><?php esc_html_e( 'Show Dailymotion:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'blogger' ) ); ?>"><?php esc_html_e( 'Show Blogger:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'delicious' ) ); ?>"><?php esc_html_e( 'Show Delicious:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'deviantart' ) ); ?>"><?php esc_html_e( 'Show Deviantart:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'digg' ) ); ?>"><?php esc_html_e( 'Show Digg:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'evernote' ) ); ?>"><?php esc_html_e( 'Show Evernote:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'forrst' ) ); ?>"><?php esc_html_e( 'Show Forrst:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'grooveshark' ) ); ?>"><?php esc_html_e( 'Show Grooveshark:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'lastfm' ) ); ?>"><?php esc_html_e( 'Show Lastfm:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'myspace' ) ); ?>"><?php esc_html_e( 'Show Myspace:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'paypal' ) ); ?>"><?php esc_html_e( 'Show Paypal:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'skype' ) ); ?>"><?php esc_html_e( 'Show Skype:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'window' ) ); ?>"><?php esc_html_e( 'Show Window:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'wordPress' ) ); ?>"><?php esc_html_e( 'Show WordPress:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'yahoo' ) ); ?>"><?php esc_html_e( 'Show Yahoo:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'yandex' ) ); ?>"><?php esc_html_e( 'Show Yandex:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'douban' ) ); ?>"><?php esc_html_e( 'Show Douban:', 'authow' ); ?></label>
                ...
                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'qq' ) ); ?>"><?php esc_html_e( 'Show QQ:', 'authow' ); ?></label>
