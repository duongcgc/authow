...
if ( ! class_exists( 'goso_facebook_widget' ) ) {
	class goso_facebook_widget extends WP_Widget {
		...
		function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_url' ) ); ?>"><?php esc_html_e( 'Facebook Page URL:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Facebook Page Height:', 'authow' ); ?></label>
                <small style="display: block; clear: both; padding-left: 0;"
                       class="description"><?php esc_html_e( 'This option is only applied when "Show Stream" option is checked', 'authow' ); ?></small>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'cover' ) ); ?>"><?php esc_html_e( 'Hide Cover Photo?', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'faces' ) ); ?>"><?php esc_html_e( 'Show Faces:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'stream' ) ); ?>"><?php esc_html_e( 'Show Stream:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'language' ) ); ?>"><?php esc_html_e( 'Custom Language:', 'authow' ); ?></label>
                <small style="display: block; clear: both; padding-left: 0;"
                       class="description"><?php _e( 'Fill the language code to use on Facebook Page Box here. By default, the language will follow the site language. See more <a href="https://developers.facebook.com/docs/internationalization/" target="_blank">here</a>', 'authow' ); ?></small>
