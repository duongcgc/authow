...
if ( ! class_exists( 'penci_latest_tweets_widget' ) ) {
	class penci_latest_tweets_widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$reply    = isset( $instance['reply'] ) ? $instance['reply'] : esc_html__( 'Reply', 'authow' );
			$retweet  = isset( $instance['retweet'] ) ? $instance['retweet'] : esc_html__( 'Retweet', 'authow' );
			$favorite = isset( $instance['favorite'] ) ? $instance['favorite'] : esc_html__( 'Favorite', 'authow' );
		...
		public function authow_widget_defaults() {
			return array(
				'title'    => esc_html__( 'Tweets', 'authow' ),
				'date'     => false,
				'auto'     => false,
				'reply'    => esc_html__( 'Reply', 'authow' ),
				'retweet'  => esc_html__( 'Retweet', 'authow' ),
				'favorite' => esc_html__( 'Favorite', 'authow' ),
				'align'    => '',
				'number'   => 5,
				'style'    => 'slider'
			);
		...
		function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of Tweet to Display:', 'authow' ); ?></label>
            ...
            <!-- Display tweets date -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'date' ) ); ?>"><?php esc_html_e( 'Hide tweets date?:', 'authow' ); ?></label>
            ...
            <!-- Disable auto play -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'auto' ) ); ?>"><?php esc_html_e( 'Disable Auto Play Tweets Slider?:', 'authow' ); ?></label>
            ...
            <!-- Custom reply text -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'reply' ) ); ?>"><?php esc_html_e( 'Custom Reply text:', 'authow' ); ?></label>
            ...
            <!-- Custom retweet text -->
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'retweet' ) ); ?>"><?php esc_html_e( 'Custom Retweet text:', 'authow' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'favorite' ) ); ?>"><?php esc_html_e( 'Custom Favorite text:', 'authow' ); ?></label>
