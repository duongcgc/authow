<?php
if ( ! function_exists( 'penci_authow_is_activated' ) ) {
	function penci_authow_is_activated() {
		return get_option( 'penci_authow_is_activated' );
	}
}

if ( ! function_exists( 'penci_authow_is_license' ) ) {
	function penci_authow_is_license() {
...
if ( ! class_exists( 'Goso_Require_Active' ) ) {
	class Goso_Require_Active {
		...
		function add_submenu_page() {
			...
			} else if ( penci_authow_is_activated() && penci_authow_is_license() ) {
				add_submenu_page( 'authow_dashboard_welcome',
		...
		function validation_notice() {
            ...
            <div class="notice notice-success is-dismissible"
                ...
                <p>
                    ...
                    - <?php _e( 'If you have issues with this please contact us via <a rel="nofollow" href="http://pencidesign.ticksy.com/" target="_blank" style="color: #0bf948;">our support forum</a> or <a style="color: #0bf948;" rel="nofollow" href="https://themeforest.net/user/pencidesign#contact" target="_blank">our contact form</a>. This notice will be removed after you activated the theme.', 'authow' ); ?>
                </p>
                <p><?php _e( 'You can check the documentation for this theme <a style="color: #0bf948;" href="https://authow.pencidesign.net/authow-document/" target="_blank">here</a> to know how to config this theme also.', 'authow' ); ?></p>
            </div>
			<?php
		}
            ...
            <div class="wrap about-wrap penci-about-wrap penci-active-theme penci-dashboard-wapper">
                ...
                <div class="penci-activate-wrap gt-tab-pane gt-is-active">
                    <div class="penci-activate-envato-code">
                        <div class="penci-activate-code-title"><?php esc_html_e( 'Active Authow', 'authow' ); ?></div>
                        ...
                        <form id="penci-check-license"
                            ...
                            <div class="penci-activate-inputs">
                                ...
                                <div class="penci-activate-err">
                                    <span class="penci-err-missing"><?php esc_html_e( 'Code is required', 'authow' ); ?></span>
                                    <span class="penci-err-length"><?php esc_html_e( 'Code is too short', 'authow' ); ?></span>
                                    <span class="penci-err-invalid"><?php esc_html_e( 'Invalid purchase code. Please check it again.', 'authow' ); ?></span>
                                </div>
                            </div>
		...
		public function theme_license_page() {
            ...
            <div class="wrap about-wrap penci-about-wrap penci-active-theme penci-dashboard-wapper">
                ...
                <div class="penci-activate-wrap gt-tab-pane gt-is-active">
                    <div class="penci-activate-envato-code">
                        <div class="penci-activate-code-title"><?php esc_html_e( 'Theme License', 'authow' ); ?></div>
						<?php $license_data = get_option( 'penci_authow_purchased_data' );
						if ( ! empty( $license_data ) ) {
							?>
                            ...
                            <p class="penci-license-detail-desc" style="font-size: 15px;">
                                ...
                                <br>
                                <a href="<?php echo admin_url( 'admin.php?page=authow_dashboard_welcome&penci_revoke_license=confirm&revoke_none=' );
		...
		public function new_update_page() {
            ...
            <div class="wrap about-wrap penci-about-wrap penci-active-theme penci-dashboard-wapper">
                ...
                <div class="penci-activate-wrap gt-tab-pane gt-is-active">
                    <div class="penci-activate-envato-code">
                        <div class="penci-activate-code-title"><?php esc_html_e( 'Update Authow Theme', 'authow' ); ?></div>
                        ...
                        <p class="penci-license-detail-desc">
							<?php _e( 'To enable Automatic Theme Updates, please check <a style="text-decoration: underline; color: #0043ff;" href="https://pencidesign.ticksy.com/article/15633/" target="_blank">this guide</a>', 'authow' ); ?>
                        </p>
                        <p class="penci-license-detail-desc">
