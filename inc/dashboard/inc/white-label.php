<?php
if ( ! class_exists( 'Goso_White_Lable' ) ) {
	class Goso_White_Lable {
		...
		public function options_page( $settings_pages ) {
			$settings_pages[] = array(
				'id'          => 'authow_white_label',
				'option_name' => 'theme_mods_' . get_stylesheet(),
				'menu_title'  => esc_html__( 'White Label ', 'authow' ),
		...
		public function options_meta_boxes( $meta_boxes ) {
			...
			$white_label_filed = array(
				array(
					...
					'name' => __( 'Activate White Label?', 'authow' ),
					'type' => 'checkbox',
				),
				array(
					'name'             => esc_html__( 'WordPress Login Logo', 'authow' ),
					'id'               => 'admin_login_logo',
					'type'             => 'image_advanced',
					'max_file_uploads' => 1,
					'max_status'       => 'false',
				...
				array(
					'name'   => esc_html__( 'Custom width for WordPress Login Logo', 'authow' ),
				...
				array(
					'name'   => esc_html__( 'Custom height for WordPress Login Logo', 'authow' ),
					'desc'   => esc_html__( 'Numeric value only, unit is pixel', 'authow' ),
				...
				array(
					'type' => 'heading',
					'name' => esc_html__( 'Background Options', 'authow' ),
				),
				array(
					'name'             => esc_html__( 'Custom background image for page login', 'authow' ),
				...
				array(
					'name' => esc_html__( 'Custom background color for page login', 'authow' ),
				...
				array(
					'type' => 'heading',
					'name' => esc_html__( 'From options', 'authow' ),
				),
				array(
					...
					'desc' => __( 'This will change the background image property of login form.', 'authow' ),
				...
				array(
					...
					'desc' => __( 'This will change the form\'s shadow property. Example: 0 1px 3px rgba(0,0,0,.13). Fill <strong>none</strong> if you want to remove shadow.', 'authow' ),
				),
				array(
				...
				array(
					...
					'type' => 'text',
					'name' => esc_html__( 'Theme Icon', 'authow' ),
					'desc' => __( 'Fill the icon class you want to display here. Check list icons <a rel="nofollow" href="https://fontawesome.com/v4.7.0/icons/" target="_blank">here</a>. Example fill: <strong>fa-book</strong>', 'authow' ),
				),
				array(
				...
				array(
					...
					'type' => 'text',
					'name' => esc_html__( 'Theme Short Name', 'authow' ),
				),
				array(
					'id'   => 'admin_wel_page_author',
					'type' => 'text',
					'name' => esc_html__( 'Theme Author', 'authow' ),
				),
				array(
					'name'    => esc_html__( 'Welcome Page Text', 'authow' ),
			...
			if ( $list_administrator ) {
				...
				$white_label_filed[] = array(
					'name'    => esc_html__( 'Show this screen settings panel only to this user', 'authow' ),
			...
			$meta_boxes[] = array(
				'id'             => 'authow_wp_banding',
				'title'          => esc_html__( 'WordPress Branding', 'authow' ),
				'settings_pages' => 'authow_white_label',
		...
		public function get_list_users() {
			...
			$output = array( '' => esc_html__( 'Administrator Users', 'authow' ) );
