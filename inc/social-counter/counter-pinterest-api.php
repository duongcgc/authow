...
if ( ! class_exists( 'Goso_Social_Counter_Pinterest_API' ) ):
	class Goso_Social_Counter_Pinterest_API {
		public static function get_count( $data, $cache_period ) {
			...
			$data['icon']    = goso_icon_by_ver( 'fab fa-pinterest' );
			$default_count   = goso_get_social_counter_option( 'pinterest_default' );
			$cache_key       = 'goso_counter__pinterest' . $user_id;
