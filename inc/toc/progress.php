...
use function Authow\Table_Of_Contents\String\br2;

class AuthowToc_Post {
	...
	private function applyContentFilter() {
		...
		remove_filter( 'the_content', array( 'GosoTOC', 'the_content' ), 100 );
		$this->post->post_content = apply_filters( 'the_content', strip_shortcodes( $this->post->post_content ) );
		add_filter( 'the_content', array( 'GosoTOC', 'the_content' ), 100 );
