            ...
            <div class="goso-col-12 pcmt-control-wrapper">
                <div class="pcmt-title">
                    <h2 style="font-weight: 600; font-size: 14px; padding-left: 0;min-width: 200px;">Select Sidebar
                        ...
                        for This Page</h2>
                    <p style="clear: both"
                       class="description"><?php esc_html_e( 'This option just apply for Page Template "Default Template", "Page with Sidebar" and "Page VC Builder with Sidebar"', 'authow' ); ?></p>
                </div>
            ...
            <div class="goso-col-12 pcmt-control-wrapper">
                <div class="pcmt-title">
                    <h2 style="font-weight: 600; font-size: 14px; padding-left: 0;min-width: 200px;">Custom Sidebar for
                        This
                        Posts/Page</h2>
                    <p class="description"><?php esc_html_e( 'Note: for page, you can choose display sidebar or no in Template "Page with Sidebar" and custom sidebar here, if sidebar you choice here is empty, will display sidebar you choice for page in customize. This option not apply for Page Template Full Width', 'authow' ); ?></p>
                </div>
                <div class="pcmt-control">
                    <p>
