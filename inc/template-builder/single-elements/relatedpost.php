...
class GosoSingleRelatedpost extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post - Related Posts', 'authow' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(), array(
				'name'     => 'post_date_typo',
				'label'    => __( 'Typography for Post Date', 'authow' ),
		...
		$this->add_control( 'btitle_outer_bcolor', array(
			'label'     => __( 'Borders Outer Color', 'authow' ),
			'type'      => \Elementor\Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'btitle_style5_bcolor', array(
			'label'     => __( 'Borders Bottom', 'authow' ),
			'type'      => \Elementor\Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
		...
		$this->add_control( 'btitle_style78_bcolor', array(
			'label'     => __( 'Small Borders Bottom on Style 7 & 8', 'authow' ),
			'type'      => \Elementor\Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => array(
