...
class GosoSingleComments extends \Elementor\Widget_Base {

	public function get_title() {
		return esc_html__( 'Post - Comments', 'authow' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'submit_btn_align', [
			'label'     => __( 'Submit Button Align', 'authow' ),
		...
		$this->start_controls_section( 'color_style', [
			'label' => esc_html__( 'Comments List', 'authow' ),
			'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
		] );

		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			'name'     => 'comment_heading_typo',
			'label'    => __( 'Typography for Heading Title', 'authow' ),
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			...
			'label'    => __( 'Typography for Author Name', 'authow' ),
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			...
			'label'    => __( 'Typography for Comment Date', 'authow' ),
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			...
			'label'    => __( 'Typography for Comment Content', 'authow' ),
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			...
			'label'    => __( 'Typography for Reply Button', 'authow' ),
		...
		$this->start_controls_section( 'comment_form_style', [
			'label' => esc_html__( 'Comment Form', 'authow' ),
			'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
		] );
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			...
			'label'    => __( 'Typography for Input Text', 'authow' ),
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			...
			'label'    => __( 'Typography for Submit Text', 'authow' ),
    ...
    <div class="comment byuser comment-author-admin even thread-even depth-1" id="comment-62" itemprop="" itemscope="itemscope" itemtype="https://schema.org/UserComments">
        ...
        <div class="thecomment">
            ...
            <div class="comment-text">
                ...
                <span class="reply">
                    <a rel="nofollow" class="comment-reply-link" href="#?replytocom=62#respond" data-commentid="62" data-postid="243" data-belowelement="comment-62" data-respondelement="respond" data-replyto="Reply to Goso" aria-label="Reply to Goso">Reply</a> </span>
            </div>
        </div>
        <div class="comment byuser comment-author-admin odd alt depth-2" id="comment-63" itemprop="" itemscope="itemscope" itemtype="https://schema.org/UserComments">
            ...
            <div class="thecomment">
                ...
                <div class="comment-text">
                    ...
                    <span class="reply">
                        <a rel="nofollow" class="comment-reply-link" href="#?replytocom=63#respond" data-commentid="63" data-postid="243" data-belowelement="comment-63" data-respondelement="respond" data-replyto="Reply to Goso" aria-label="Reply to Goso">Reply</a> </span>
                </div>
            </div>
        </div><!-- #comment-## -->
    </div><!-- #comment-## -->
    <div class="comment byuser comment-author-admin even thread-odd thread-alt depth-1" id="comment-64" itemprop="" itemscope="itemscope" itemtype="https://schema.org/UserComments">
        ...
        <div class="thecomment">
            ...
            <div class="comment-text">
                ...
                <span class="reply">
                    <a rel="nofollow" class="comment-reply-link" href="#?replytocom=64#respond" data-commentid="64" data-postid="243" data-belowelement="comment-64" data-respondelement="respond" data-replyto="Reply to Goso" aria-label="Reply to Goso">Reply</a> </span>
            </div>
        </div>
    </div><!-- #comment-## -->
</div>';
