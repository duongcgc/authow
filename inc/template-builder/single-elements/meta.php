...
class GosoSingleMeta extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post - Meta', 'authow' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'meta_align', [
			'label'     => __( 'Meta Text Align', 'authow' ),
		...
		$this->add_control( 'hide_meta_label', [
			'label' => __( 'Hide Meta Label Text', 'authow' ),
			'type'  => \Elementor\Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'justify_align', [
			'label'     => __( 'Justify Align?', 'authow' ),
			'type'      => \Elementor\Controls_Manager::SWITCHER,
		...
		$this->start_controls_section( 'icon_settings', [
			'label' => esc_html__( 'Icon Settings', 'authow' ),
			'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
		] );
