...
class GosoSinglePostpagination extends \Elementor\Widget_Base {

	public function get_title() {
		return esc_html__( 'Post - Post Pagination', 'authow' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control( \Elementor\Group_Control_Typography::get_type(), array(
			'name'     => 'post_desc_typo',
			'label'    => __( 'Typography for Small Text Description', 'authow' ),
		...
		$this->add_responsive_control( 'post_spacing', array(
			'label'     => __( 'Spacing Between Next & Previous Posts', 'authow' ),
			'type'      => \Elementor\Controls_Manager::SLIDER,
		...
		$this->add_control( 'prev_post_bdstyle', array(
			...
			'options'   => [
				...
				'double' => esc_html__( 'Double', 'authow' ),
