...
class GosoArchiveTaxonomy extends Widget_Base {

	public function get_title() {
		return esc_html__( 'Archive - Taxonomies', 'authow' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'tax_showall', [
			'label'   => esc_html__( 'Term Listing', 'authow' ),
		...
		$this->add_control( 'number', [
			'label'       => esc_html__( 'Limit Terms to Show', 'authow' ),
			'description' => esc_html__( 'This option is visible on frontend only.', 'authow' ),
		...
		$this->add_control( 'tax_currentitem', [
			'label' => esc_html__( 'Activate Current Viewing Term?', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'tax_showcount', [
			'label' => esc_html__( 'Show Posts Count', 'authow' ),
			'type'  => Controls_Manager::SWITCHER,
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), array(
			'name'     => 'term_typo',
			'label'    => __( 'Typography for Term', 'authow' ),
