...
<div class="mag-post-box hentry<?php if ( $m < 3 ): echo ' first-post'; endif; ?>">
    <div class="magcat-thumb">
		...
		<?php if ( ! get_theme_mod( 'goso_disable_lazyload_layout' ) ) { ?>
            <a class="goso-image-holder goso-lazy<?php if ( $m > 2 ): echo ' small-fix-size'; endif; ?><?php echo goso_class_lightbox_enable(); ?>"
		...
		<?php } else { ?>
            <a class="goso-image-holder<?php if ( $m > 2 ): echo ' small-fix-size'; endif; ?><?php echo goso_class_lightbox_enable(); ?>"
    ...
    <div class="magcat-detail">
        ...
        <div class="mag-header"><?php endif; ?>
			...
			<?php if ( ( ( $m < 3 || get_theme_mod( 'goso_home_cat_author_sposts' ) ) && ! get_theme_mod( 'goso_home_featured_cat_author' ) ) || ! get_theme_mod( 'goso_home_featured_cat_date' ) || get_theme_mod( 'goso_home_featured_cat_comment' ) || get_theme_mod( 'goso_home_cat_views' ) || goso_isshow_reading_time( $hide_readtime ) ): ?>
                <div class="grid-post-box-meta mag-meta">
					<?php if ( ( $m < 3 || get_theme_mod( 'goso_home_cat_author_sposts' ) ) && ! get_theme_mod( 'goso_home_featured_cat_author' ) ) : ?>
		...
		<?php if ( $m < 3 && get_the_excerpt() && ! get_theme_mod( 'goso_home_featured_cat_remove_excerpt' ) ): ?>
