<?php
if ( ! class_exists( 'Goso_Add_Options_To_Gallery_Setting' ) ) {
	class Goso_Add_Options_To_Gallery_Setting {
		/**
		 * Stores the class instance.
		 *
		 * @var Goso_Add_Options_To_Gallery_Setting
		 */
		 ...
		 *
		 * @return Goso_Add_Options_To_Gallery_Setting The instance
		 */
	...
	add_action( 'admin_init', array( Goso_Add_Options_To_Gallery_Setting::get_instance(), 'init_plugin' ), 20 );
}