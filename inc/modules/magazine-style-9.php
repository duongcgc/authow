...
<div class="mag-post-box hentry">
    <div class="magcat-thumb">
		...
		<?php if ( ! get_theme_mod( 'goso_disable_lazyload_layout' ) ) { ?>
            <a class="goso-image-holder goso-lazy small-fix-size<?php echo goso_class_lightbox_enable(); ?>"
		...
		<?php } else { ?>
            <a class="goso-image-holder small-fix-size<?php echo goso_class_lightbox_enable(); ?>"
    ...
    <div class="magcat-detail">
		...
		<?php if ( get_theme_mod( 'goso_home_cat_author_sposts' ) || ! get_theme_mod( 'goso_home_featured_cat_date' ) || get_theme_mod( 'goso_home_featured_cat_comment' ) || get_theme_mod( 'goso_home_cat_views' ) || goso_isshow_reading_time( $hide_readtime ) ): ?>
            <div class="grid-post-box-meta mag-meta">
				<?php if ( get_theme_mod( 'goso_home_cat_author_sposts' ) ) : ?>
