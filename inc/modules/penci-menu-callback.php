...
class penci_nav_menu_edit_walker extends Walker_Nav_Menu_Edit {
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$menu_control .= '<p class="description description-wide penci-authow-description penci-hide-child">';
		...
		$menu_control .= '<p class="description penci-mn-settings mega-menu-select description-wide penci-authow-description penci-hide-child">';
		...
		$menu_control .= '<span class="description pcajax-change"><a target="_blank" class="penciblock-edit-link" data-url="' . esc_url( admin_url( 'post.php?action=edit&post=' ) ) . '" href="' . esc_url( admin_url( 'post.php?action=edit&post=' . $penci_menu_block_id . '' ) ) . '">Edit This Block</a> | <a target="_blank" href="' . esc_url( admin_url( 'edit.php?post_type=penci-block' ) ) . '">' . __( 'Add New Block', 'authow' ) . '</a></span>';
		$menu_control .= '<span class="description pcajax-none">' . __( 'You can add new a Goso Block on <a target="_blank" href="' . esc_url( admin_url( 'edit.php?post_type=penci-block' ) ) . '">this page</a>', 'authow' ) . '</span>';
		...
		$menu_control .= '<p data-imgid="' . esc_attr( $item->ID ) . '" class="description penci-mn-settings mega-menu-select description-wide penci-authow-description penci-hide-child">';
		...
		$menu_control .= '<p class="description penci-mn-settings cat-menu-select description-wide penci-authow-description penci-hide-child">';
		$menu_control .= '<label>';
		...
		$menu_control .= '<p class="description all-menu-select description-wide penci-authow-description penci-hide-child">';
