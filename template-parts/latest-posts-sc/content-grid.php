	...
	<article id="post-<?php the_ID(); ?>" class="item hentry">
		...
		<?php elseif ( has_post_thumbnail() ) : ?>
			<div class="thumbnail">
				...
				<?php } else { ?>
				<a class="goso-image-holder<?php echo goso_class_lightbox_enable(); ?>" style="background-image: url('<?php echo goso_get_featured_image_size( get_the_ID(), goso_featured_images_size_vcel( 'normal', $goso_featimg_size, $thumb_size ) ); ?>');" href="<?php goso_permalink_fix(); ?>" title="<?php
...
if( isset( $infeed_ads ) && $infeed_ads ){
	goso_get_markup_infeed_ad(
		array(
			'wrapper' => 'li',
			'classes'      => 'grid-style goso-infeed-data goso-infeed-vcele',
