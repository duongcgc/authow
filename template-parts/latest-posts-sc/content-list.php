...
?>
    <li class="list-post goso-item-listp">
        <article id="post-<?php the_ID(); ?>" class="item hentry">
            ...
            <div class="content-list-right content-list-center<?php if ( ! has_post_thumbnail() ) : echo ' fullwidth'; endif; ?>">
				...
				<?php if ( 'yes' != $grid_share_box ) : ?>
                    <div class="goso-post-box-meta goso-post-box-grid goso-post-box-listpost">
...
if ( isset( $infeed_ads ) && $infeed_ads ) {
	goso_get_markup_infeed_ad(
		array(
			'wrapper'    => 'li',
			'classes'    => 'list-post goso-item-listp goso-infeed-data goso-infeed-vcele',
