    ...
    <div class="header-standard header-classic single-header">
		...
		<?php if ( ! get_theme_mod( 'goso_single_meta_author' ) || ! get_theme_mod( 'goso_single_meta_date' ) || ! get_theme_mod( 'goso_single_meta_comment' ) || get_theme_mod( 'goso_single_show_cview' ) || goso_isshow_reading_time( $hide_readtime ) ) : ?>
            <div class="post-box-meta-single">
				...
				<?php endif; ?>
				<?php
				if ( get_the_post_thumbnail_caption() && get_theme_mod( 'goso_post_thumb_caption' ) && in_array( $single_style, array(
						'style-5',
						'style-6',
						'style-8'
					) ) && ! $move_title_bellow ) {
...
$move_title_bellow = get_theme_mod( 'goso_move_title_bellow' );
$show              = true;
if ( ( ! $move_title_bellow && in_array( $single_sstyle, [
			'style-5',
			'style-6',
			'style-8',
			'style-10'
...
if ( $show && ( 'btitle-bcontent' == get_theme_mod( 'goso_single_poslcscount' ) || 'btitle' == get_theme_mod( 'goso_single_poslcscount' ) ) ) {
