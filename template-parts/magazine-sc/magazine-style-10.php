    ...
    <div class="magcat-detail">
        ...
        <div class="mag-header"><?php endif; ?>
            <h3 class="magcat-titlte entry-title"><a
                        href="<?php the_permalink(); ?>"><?php goso_trim_post_title( get_the_ID(), ( $m < 3 ? $big_title_length : $_title_length ) ); ?></a>
            </h3>
			<?php if ( ( ( $m < 3 || $show_author_sposts ) && 'yes' != $hide_author ) || 'yes' != $hide_date || 'yes' == $show_viewscount || 'yes' == $show_commentcount || goso_isshow_reading_time( $hide_readtime ) ): ?>
