 ...
 * @since 1.0
 */
$thumbsize = goso_featured_images_size( 'small' );
...
<div class="mag-post-box hentry">
    ...
    <div class="magcat-detail">
		...
		<?php if ( $show_author_sposts || 'yes' != $hide_date || 'yes' == $show_viewscount || 'yes' == $show_commentcount || goso_isshow_reading_time( $hide_readtime ) ): ?>
