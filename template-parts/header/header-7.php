<?php if ( ! get_theme_mod( 'goso_vertical_nav_show' ) ) : ?>
	...
	?>
	<nav id="navigation" class="<?php echo esc_attr( $navigation_class ); ?>" role="navigation" <?php if( ! get_theme_mod('goso_schema_sitenav') ): ?>itemscope itemtype="https://schema.org/SiteNavigationElement"<?php endif; ?>>
