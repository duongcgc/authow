<?php
if( get_theme_mod( 'goso_enable_featured_video_bg' ) && get_theme_mod( 'goso_featured_video_url' ) ) {
	get_template_part( 'inc/featured_slider/featured_video' );
} else {
	if ( get_theme_mod( 'goso_featured_slider' ) == true ) :
		$slider_style = get_theme_mod( 'goso_featured_slider_style' ) ? get_theme_mod( 'goso_featured_slider_style' ) : 'style-1';

		if( ( $slider_style == 'style-33' || $slider_style == 'style-34' ) && get_theme_mod( 'goso_feature_rev_sc' ) ) {
			$rev_shortcode = get_theme_mod( 'goso_feature_rev_sc' );
			...
			if( get_theme_mod( 'goso_enable_flat_overlay' ) && in_array( $slider_style, array( 'style-6', 'style-7', 'style-8', 'style-9', 'style-10', 'style-11', 'style-12', 'style-13', 'style-14', 'style-15', 'style-16', 'style-17', 'style-18', 'style-19', 'style-20', 'style-21', 'style-22', 'style-23', 'style-24', 'style-25', 'style-26', 'style-27', 'style-28' ) ) ): $slider_class .= ' goso-flat-overlay'; endif;
			...
			echo '<div class="goso-owl-carousel goso-owl-featured-area"'. $data_res .' data-style="'. $slider_style .'" data-auto="'. $data_auto .'" data-autotime="'. $auto_time .'" data-speed="'. $auto_speed .'" data-loop="'. $data_loop .'">';
