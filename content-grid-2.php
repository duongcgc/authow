...
?>
<li class="grid-style grid-2-style<?php if ( get_theme_mod( 'goso_grid_meta_overlay' ) ): echo ' grid-overlay-meta'; endif; ?>">
...
if ( isset( $infeed_ads ) && $infeed_ads ) {
	goso_get_markup_infeed_ad(
		array(
			'wrapper'    => 'li',
			'classes'    => 'grid-style grid-2-style goso-infeed-data',
