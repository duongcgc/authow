...
<article id="post-<?php the_ID(); ?>" class="<?php echo $standard_class; ?>">
	...
	<?php if ( ! get_theme_mod( 'goso_standard_thumbnail' ) ): ?>
		...
		<?php if ( goso_get_post_format( 'link' ) || goso_get_post_format( 'quote' ) ) : ?>
            <div class="standard-post-special<?php if ( goso_get_post_format( 'quote' ) ): ?> goso-special-format-quote<?php endif; ?><?php if ( ! has_post_thumbnail() || get_theme_mod( 'goso_standard_thumbnail' ) ) : echo ' no-thumbnail'; endif; ?>">
				<?php if ( has_post_thumbnail() && ! get_theme_mod( 'goso_standard_thumbnail' ) ) : ?>
					<?php if ( ! get_theme_mod( 'goso_disable_lazyload_layout' ) ) { ?>
                        <a <?php if ( get_theme_mod( 'goso_standard_thumb_crop' ) ): ?> class="goso-image-holder goso-lazy" data-bgset="<?php echo goso_get_featured_image_size( get_the_ID(), 'goso-full-thumb' ); ?>"<?php endif; ?>
...
if ( isset( $infeed_ads ) && $infeed_ads ) {
	goso_get_markup_infeed_ad(
		array(
			'wrapper'    => 'article',
			'classes'    => 'standard-article classic-pitem post goso-infeed-data',
