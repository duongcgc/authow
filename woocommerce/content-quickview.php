...
$content_style = get_theme_mod( 'goso_woocommerce_quickview_variations', true ) ? 'show-variable' : 'hide-variable';
?>
<div class="goso-content-quickview">
    <div id="product-<?php the_ID(); ?>" <?php wc_product_class( $content_style, $product ); ?>>
        ...
        <div class="entry-summary-wrapper goso-scroll">
