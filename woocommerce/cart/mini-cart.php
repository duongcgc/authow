...
if ( ! is_null( WC()->cart ) && ! WC()->cart->is_empty() ) : ?>
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                ...
                <li data-key="<?php echo esc_attr( $cart_item_key ); ?>"
                    ...
                    <div class="product-cart-info">
						...
						<?php
						if ( ! $_product->is_sold_individually() && $_product->is_purchasable() && get_theme_mod( 'goso_shop_mini_cart_quantity', true ) ) {
    ...
    <div class="goso-woo-cart-total-group">
    ...
    <div class="goso-woo-cart-buttons-group">
