...
if ( get_theme_mod( 'goso_page_default_template_layout' ) == 'two-sidebar' ) {
	$sidebar_position = 'two-sidebar';
} elseif ( get_theme_mod( 'goso_page_default_template_layout' ) == 'left-sidebar' ) {
	$sidebar_position = 'left-sidebar';
}

$page_sidebar = get_post_meta( get_the_ID(), 'goso_sidebar_page_pos', true );
if( $page_sidebar ) {
...
if( in_array( $page_meta, array('style-1', 'style-2', 'style-3', 'style-4', 'style-5', 'style-6', 'style-7', 'style-8', 'style-9', 'style-10', 'style-11', 'style-12', 'style-13', 'style-14', 'style-15', 'style-16', 'style-17', 'style-18', 'style-19', 'style-20', 'style-21', 'style-22', 'style-23', 'style-24', 'style-25',	'style-26', 'style-27', 'style-28', 'style-29', 'style-30',	'style-31', 'style-32', 'style-33', 'style-34', 'style-35', 'style-36', 'style-37', 'style-38', 'video' ) ) ) {
	if( $page_meta == 'video' && get_theme_mod( 'goso_featured_video_url' ) ) {
		...
		if( ( $page_meta == 'style-33' || $page_meta == 'style-34' ) && $rev_shortcode ) {
			...
			if( get_theme_mod( 'goso_enable_flat_overlay' ) && in_array( $page_meta, array( 'style-6', 'style-7', 'style-8', 'style-9', 'style-10', 'style-11', 'style-12', 'style-13', 'style-14', 'style-15', 'style-16', 'style-17', 'style-18', 'style-19', 'style-20', 'style-21', 'style-22', 'style-23', 'style-24', 'style-25', 'style-26', 'style-27', 'style-28' ) ) ): $slider_class .= ' goso-flat-overlay'; endif;
...
<?php endif; ?>
    ...
    <div class="container goso_sidebar <?php echo esc_attr( $sidebar_position ); ?>">
            ...
            <div class="theiaStickySidebar">
				...
				<?php if ( ! $show_page_title ): ?>
					<?php if ( ! get_theme_mod( 'goso_disable_breadcrumb' ) && ( 'no' != $breadcrumb ) && get_theme_mod( 'goso_move_breadcrumbs' ) ): ?>
						...
						$yoast_breadcrumb = '';
						if ( function_exists( 'yoast_breadcrumb' ) ) {
							$yoast_breadcrumb = yoast_breadcrumb( '<div class="container container-single-page goso-breadcrumb goso-crumb-inside">', '</div>', false );
						}

						if ( $yoast_breadcrumb ) {
							echo $yoast_breadcrumb;
						} else { ?>
                            <div class="container container-single-page goso-breadcrumb goso-crumb-inside">
                                <span><a class="crumb"
